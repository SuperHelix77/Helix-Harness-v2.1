...
def test_unsloth_deep_link_parser_guardrails(tmp_path: Path) -> None:
    ...
    script = textwrap.dedent("""
        ...
        const valid = new Map([
          [
            "helixharness://open_from_hf?model=unsloth/Laguna-S-2.1-GGUF",
...
def test_tauri_registers_only_the_helix_scheme() -> None:
    ...
    assert "MimeType=x-scheme-handler/helixharness;" in desktop
