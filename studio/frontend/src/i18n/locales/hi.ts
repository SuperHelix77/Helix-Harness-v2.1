...
export const hi = {
	picker: {
		...
		offlineBody: "कैश किए गए या स्थानीय {noun} का उपयोग करने के लिए डिवाइस पर जाएं।",
		...
		multipleMatches: "एक से अधिक मेल खाते {noun} मिले। सूची में से एक चुनें।",
		rateLimitedTitle: "Hugging Face की अनुरोध सीमा पूरी हो गई",
		rateLimitedBody: "कुछ देर प्रतीक्षा करें, फिर {noun} की खोज दोबारा करें।",
		hfToken: {
			label: "HF टोकन",
			saved: "सहेजा गया",
			add: "जोड़ें",
			...
			savedHint: "टोकन सहेजा गया। इसका उपयोग करने पर एक्सेस की जांच की जाएगी।",
			addHint: "निजी और गेटेड रिपॉज़िटरी एक्सेस करने के लिए टोकन सेट करें।",
		},
	},
	common: {
		cancel: "रद्द करें",
	...
	settings: {
		groups: {
			...
			identityData: "पहचान और डेटा",
			runtimeAccess: "रनटाइम और पहुँच",
			support: "सहायता",
		},
		accounts: {
			title: "खाते",
			description:
				"निजी Studio खाते बनाएँ। नए उपयोगकर्ता एक बार इस्तेमाल होने वाले सेटअप कोड से साइन इन करते हैं और पासवर्ड चुनते हैं।",
			username: "उपयोगकर्ता नाम",
			create: "खाता बनाएँ",
			setupCode: "सेटअप कोड",
			setupFor: "{username} के लिए सेटअप कोड",
			shownOnce:
				"यह कोड अभी कॉपी करें और खाता धारक को दें। यह केवल यहीं दिखता है और 60 मिनट के भीतर एक बार इस्तेमाल किया जा सकता है।",
		...
		debugging: {
			...
			source: "लॉग फ़ाइल",
			sourceHint:
				"मॉडल रनर अपने अलग लॉग लिखते हैं, इसलिए लोड या जनरेशन विफल होने का कारण अक्सर सर्वर लॉग के बजाय वहीं मिलता है।",
			path: "स्थान",
			...
			privacyNote:
				"इस दृश्य में क्रेडेंशियल छिपा दिए जाते हैं। डिस्क पर मौजूद फ़ाइल में वे नहीं छिपाए जाते।",
			...
			droppedNotice:
				"कुछ पंक्तियाँ छोड़ दी गईं: लॉग इतनी तेज़ी से लिखा गया कि उसे पढ़ा नहीं जा सका।",
			...
			exportMaskedNote:
				"निर्यात की गई फ़ाइलों में क्रेडेंशियल छिपा दिए जाते हैं। बहुत बड़े लॉग केवल अपनी सबसे हाल की पंक्तियाँ रखते हैं, और कुछ लॉग पूरी तरह छूट सकते हैं; संग्रह में EXPORT_WARNINGS.txt देखें।",
			...
			exportTooOld:
				"चल रहा Unsloth बैकएंड लॉग निर्यात करने के लिए बहुत पुराना है। उस बैकएंड को अपडेट करें और पुनः आरंभ करें।",
			exportForbidden:
				"सभी लॉग डाउनलोड करने के लिए साइन-इन किया हुआ Studio सत्र चाहिए। केवल API कुंजी पर्याप्त नहीं है।",
			keywords:
				"डिबग डिबगिंग लॉग त्रुटि गड़बड़ी क्रैश ट्रेसबैक निदान समस्या निवारण debug log logs error",
		},
		voice: {
			title: "आवाज़",
			...
			dictation: {
				...
				connectionDescription: "कनेक्शन में OpenAI-संगत सर्वर और वैकल्पिक API कुंजी जोड़ें।",
			...
			dictionary: {
				...
				sectionDescription: "तय करें कि डिक्टेशन कुछ खास शब्द या वाक्यांश कैसे लिखे",
			...
			recents: {
				...
				sectionDescription: "हर डिक्टेशन यहाँ सहेजा जाता है ताकि आप टेक्स्ट वापस पा सकें",
				...
				clearDescription: "सभी सहेजे गए डिक्टेशन हटाएँ? इसे पूर्ववत नहीं किया जा सकता।",
			...
			readAloud: {
				...
				connectionPlaceholder: "कनेक्शन चुनें",
				customModelLabel: "मॉडल",
				customVoiceDescription: "एंडपॉइंट द्वारा अपेक्षित वॉइस नाम; डिफ़ॉल्ट alloy है",
				modelLabel: "TTS मॉडल",
				modelDescription: "मॉडल सिलेक्टर से एक ऑडियो मॉडल लोड करें (जैसे Orpheus TTS)",
		...
		general: {
			...
			passwordDialog: {
				...
				samePassword: "नया पासवर्ड आपके वर्तमान पासवर्ड से अलग होना चाहिए।",
			...
			autoTitleNewChatsDescription: "पहले संदेश से एक छोटा शीर्षक बनाएं।",
			helperLlm: {
		...
		appearance: {
			...
			palette: {
				...
				minimal: "मिनिमल",
				glass: "तटस्थ ग्लास",
				materialPresets: "मटेरियल प्रीसेट",
				opaque: "अपारदर्शी",
				balanced: "संतुलित",
				airy: "हल्का",
				advancedMaterials: "उन्नत मटेरियल नियंत्रण",
				sidebarSurface: "साइडबार",
				chatSurface: "चैट सतह",
				composerSurface: "कंपोज़र",
				rightRailSurface: "दायाँ पैनल",
				mainTransparency: "मुख्य बैकग्राउंड की पारदर्शिता",
				opacity: "ग्लास अपारदर्शिता",
				opacityDescription:
					"फ्रॉस्टेड सतहें कितनी ठोस दिखें। कम मान से वे अधिक पारदर्शी होंगी।",
				blur: "ग्लास ब्लर",
				blurDescription: "साइडबार, कार्ड और कंपोज़र पर फ्रॉस्ट प्रभाव की तीव्रता।",
			},
			custom: {
				reset: "रीसेट करें",
				...
				pointerCursors: {
					...
					description: "इंटरैक्टिव तत्वों पर होवर करने पर कर्सर को पॉइंटर में बदलें।",
				},
			},
			language: {
				title: "भाषा",
		...
		resources: {
			...
			llamaBackend: {
				...
				applyHint:
					"नया बिल्ड डाउनलोड करके llama.cpp को फिर से शुरू करता है। लोड किया गया मॉडल अनलोड हो जाएगा।",
				applyHintWithSize:
					"{size} डाउनलोड करके llama.cpp को फिर से शुरू करता है। लोड किया गया मॉडल अनलोड हो जाएगा।",
				...
				envLocked:
					"पर्यावरण चर UNSLOTH_LLAMA_CPP_BACKEND ने इसे {backend} पर तय किया है, जो इस सेटिंग पर भारी पड़ता है।",
				customPath: {
					...
					bundled:
						"Unsloth द्वारा इंस्टॉल किया गया llama.cpp रनटाइम इस्तेमाल करता है।",
					active:
						"अगली बार मॉडल लोड होने पर आपका कस्टम llama-server इस्तेमाल होगा।",
					environmentManaged: "{variable} पर्यावरण चर द्वारा प्रबंधित।",
					missingBinary:
						"इस फ़ोल्डर में llama-server अब उपलब्ध नहीं है। दूसरा फ़ोल्डर चुनें या बंडल रनटाइम इस्तेमाल करें।",
					reloadRequired:
						"चुने हुए llama-server को इस्तेमाल करने के लिए मॉडल फिर से लोड करें।",
					change: "बदलें",
					saving: "सहेजा जा रहा है...",
				...
				unsupported: {
					notInstalled:
						"कोई प्रबंधित llama.cpp इंस्टॉल नहीं मिला, इसलिए बदलने के लिए कोई बैकएंड नहीं है।",
					localLink:
						"llama.cpp आपकी अपनी लिंक की हुई लोकल डायरेक्टरी है, इसलिए Unsloth उसे नहीं बदलेगा।",
					sourceBuild:
						"यह llama.cpp सोर्स से बनाया गया है, इसलिए इसका बैकएंड यहाँ से नहीं बदला जा सकता।",
					customPath:
						"एक कस्टम llama.cpp फ़ोल्डर चुना गया है। उसका बिल्ड कंप्यूट बैकएंड तय करता है।",
					unresolved:
						"उपलब्ध बैकएंड की जाँच नहीं हो सकी। अपना कनेक्शन देखकर दोबारा कोशिश करें।",
				},
			...
			modelMemory: {
				...
				keepResidentHint:
					"जब तक मॉडल लोड रहता है, वेट्स सिस्टम RAM को वापस नहीं दिए जाते। निष्क्रिय होने पर स्वतः अनलोड बंद कर देता है, और जब वेट्स वास्तव में होस्ट RAM में रहते हैं (यूनिफाइड मेमोरी, या आंशिक GPU ऑफ़लोड) तब --mlock भी भेजता है, ताकि OS उन्हें पेज आउट करके आपके अगले प्रॉम्प्ट पर दोबारा अपलोड न करे।",
				noRamReserve: "मॉडल के लिए सिस्टम RAM आरक्षित न करें",
				noRamReserveDescription: "मॉडल वेट्स के लिए रखी गई RAM घटाता है।",
				noRamReserveHint:
					"जब मॉडल पूरी तरह GPU पर ऑफ़लोड हो, तो समर्थित Windows बिल्ड पर मेमोरी-मैप्ड लोडिंग छोड़ देता है, ताकि उसके पेज रेज़िडेंट न रहें। अन्यथा मेमोरी-मैप्ड लोडिंग बनाए रखता है। आवश्यक CPU बफ़र अब भी RAM ले सकते हैं। --no-mmap तथा --mlock हटा देता है।",
				mlockVetoed:
					"--mlock बंद ही रहता है: मॉडल को पिन करने से उसकी पूरी मात्रा के लिए RAM आरक्षित हो जाएगी। निष्क्रिय होने पर स्वतः अनलोड अब भी अक्षम है।",
				memlockCapped:
					"यह सिस्टम लॉक की गई मेमोरी को {limit} तक सीमित करता है। इससे बड़ा मॉडल पूरी तरह पिन नहीं होगा; ulimit -l से सीमा बढ़ाएँ।",
			...
			storage: {
				...
				modelsFolderHint:
					"डाउनलोड किए गए मॉडल कहाँ संग्रहीत होते हैं। मॉडल को अपनी सिस्टम ड्राइव से दूर रखने के लिए इसे बदलें। यह केवल नए डाउनलोड पर लागू होता है। आपके पास पहले से मौजूद मॉडल वहीं रहते हैं।",
				openAction: "खोलें",
				copyAction: "पथ कॉपी करें",
				copied: "पथ कॉपी किया गया",
				openError: "फ़ोल्डर नहीं खोला जा सका",
		...
		agents: {
			...
			options: {
				...
				loadIn4bit: "Hugging Face मॉडलों के लिए 4-बिट लोडिंग चालू या बंद करता है।",
				...
				persist: "Unsloth द्वारा प्रबंधित एजेंट स्टोरेज को रनों के बीच बनाए रखता है।",
				asSubagent:
				...
				apiKey: "आपकी Unsloth API key लेता है (या UNSLOTH_API_KEY सेट करें)।",
				reasoning:
				...
				yolo: "मंज़ूरी के प्रॉम्प्ट छोड़ देता है। केवल भरोसेमंद वातावरण में उपयोग करें।",
			},
			remote: {
		...
		chat: {
			...
			pastedTextThresholdDescription:
				"इससे लंबा चिपकाया गया टेक्स्ट संदेश बॉक्स भरने के बजाय .txt अटैचमेंट बन जाता है। {shortcut} दबाने पर यह फिर भी संदेश बॉक्स में चिपकेगा।",
			pastedTextThresholdOff: "बंद",
			showResponseModel: "जवाब देने वाला मॉडल दिखाएँ",
			showResponseModelDescription: "असिस्टेंट के जवाबों में मॉडल का मेटाडेटा दिखाएँ।",
			...
			importedChatCount: "{count} वार्तालाप हाल के सेक्शन में इंपोर्ट किए गए।",
			importingChats: "चैट इंपोर्ट हो रही हैं: अब तक {count} ({percent}%)...",
			importedChatCountPartial:
				"{count} बातचीत Recents में इंपोर्ट की गईं; {failed} सेव नहीं हो सकीं।",
			...
			clearOneChatDescription: "इस डिवाइस पर एकमात्र चैट को स्थायी रूप से हटाएं।",
		...
		data: {
			...
			archivedChatsDescription: "आपने जो चैट संग्रहित की हैं उन्हें देखें और प्रबंधित करें।",
			archivedImages: "संग्रहित छवियाँ",
			archivedImagesDescription:
				"आपके द्वारा संग्रहित की गई छवियाँ देखें और प्रबंधित करें।",
			archivedVideos: "संग्रहित वीडियो",
			archivedVideosDescription:
				"आपके द्वारा संग्रहित किए गए वीडियो देखें और प्रबंधित करें।",
			archivedAudio: "संग्रहित ऑडियो",
			archivedAudioDescription:
				"आपके द्वारा संग्रहित किए गए ऑडियो क्लिप देखें और प्रबंधित करें।",
		...
		about: {
			...
			update: {
				...
				pullThenUpdate: "नवीनतम परिवर्तन खींचें, फिर स्थानीय इंस्टॉलर चलाएं:",
				...
				desktopCheckingDescription: "इसमें आम तौर पर कुछ सेकंड लगते हैं।",
				...
				desktopManualInstall: "नवीनतम Linux पैकेज इंस्टॉल करने के लिए रिलीज़ पेज खोलें।",
				desktopCheckFailed: "अपडेट की जाँच नहीं हो सकी",
				desktopCheckFailedDescription: "अपना कनेक्शन जाँचें और फिर से कोशिश करें।",
	...
	studio: {
		...
		wizard: {
			...
			methodTooltip:
				"मॉडल को कैसे ट्रेन किया जाता है। LoRA और QLoRA सभी वेट्स के बजाय छोटे अडैप्टर अपडेट करते हैं।",
			datasetTooltip:
				"मॉडल को फ़ाइन-ट्यून करने के लिए उपयोग किया जाने वाला ट्रेनिंग डेटा।",
			hfTokenDescription: "गेटेड या निजी मॉडल और डेटासेट के लिए आवश्यक।",
		...
		preview: {
			...
			noticeDatasetPartial: "ट्रेनिंग डेटासेट पढ़ने से पहले उसका अधूरा डाउनलोड पूरा करेगी।",
		...
		datasetPicker: {
			...
			someLocationsUnscanned: "कुछ डेटासेट स्थान स्कैन नहीं किए जा सके।",
			noLocalDatasets:
		...
		modelPicker: {
			...
			noLocalModelsHint: "ऊपर फ़ोल्डर पथ पेस्ट करें या Hugging Face पर जाएं।",
			searchingHub: "Hugging Face पर खोजा जा रहा है…",
			...
			reasonNotTrainable: "इस डिवाइस पर मौजूद मॉडल को ट्रेन नहीं किया जा सकता।",
			reasonUnsupportedFormat: "यह मॉडल फ़ॉर्मेट ट्रेनिंग के लिए समर्थित नहीं है।",
		...
		dataset: {
			...
			streaming: {
				...
				description: "Hugging Face टेक्स्ट डेटासेट को डाउनलोड करने के बजाय स्ट्रीम करें।",
				unavailable: "स्ट्रीमिंग उपलब्ध नहीं है। इसे चालू करने के लिए:",
				completionsUnavailable: "डेटासेट स्ट्रीमिंग चालू होने पर उपलब्ध नहीं है।",
				blockers: {
					source:
					...
					imageDataset: "यह डेटासेट इमेज वाला लगता है, जिसे स्ट्रीम नहीं किया जा सकता।",
					audioDataset:
						"यह डेटासेट ऑडियो वाला लगता है, जिसे स्ट्रीम नहीं किया जा सकता।",
					appleSilicon: "Apple Silicon (MLX) पर अभी स्ट्रीमिंग समर्थित नहीं है।",
				},
				options: {
		...
		params: {
			...
			rank: "Rank",
			rankTooltip: "लो-रैंक मैट्रिक्स का आयाम। अधिक = अधिक क्षमता।",
			alpha: "Alpha",
			alphaTooltip: "LoRA अपडेट के लिए स्केलिंग फ़ैक्टर। आमतौर पर rank का 2x।",
			dropout: "Dropout",
			dropoutTooltip: "ओवरफ़िटिंग कम करने के लिए LoRA लेयर्स के लिए dropout प्रायिकता।",
			...
			batchSize: "बैच साइज़",
			batchSizeTooltip:
				"प्रति स्टेप प्रोसेस किए गए सैंपल। अधिक होने पर अधिक VRAM उपयोग करता है।",
			...
			warmupStepsTooltip: "स्थिरता के लिए ट्रेनिंग की शुरुआत में LR को धीरे-धीरे बढ़ाएं।",
		...
		training: {
			...
			configTooLarge: "प्रशिक्षण कॉन्फ़िगरेशन फ़ाइल बहुत बड़ी है (अधिकतम 1 MiB)।",
		...
		history: {
			...
			deleteArtifactsFailed: "रन हटा दिया गया, लेकिन उसकी फ़ाइलें नहीं हटाई जा सकीं।",
		...
		charts: {
			...
			settingsDescription: "ट्रेनिंग चलते रहने के दौरान चार्ट प्रस्तुति को समायोजित करें।",
	...
	skills: {
		title: "एजेंट कौशल",
		description:
			"कौशल आपके मानक एजेंट फ़ोल्डरों से खोजे जाते हैं। उन्हें यहाँ सक्षम करें, फिर चैट में @ टाइप करके किसी का उल्लेख करें।",
		precedence: "~/.agents/skills को ~/.claude/skills पर प्राथमिकता मिलती है।",
		refresh: "रीफ़्रेश",
		empty:
			"कोई एजेंट कौशल नहीं मिला। ~/.agents/skills या ~/.claude/skills में SKILL.md फ़ोल्डर जोड़ें, फिर रीफ़्रेश करें।",
		sourceAgents: "Agents",
		sourceClaude: "Claude",
