...
export const en = {
	...
	settings: {
		accounts: {
			title: "Accounts",
			description:
				"Create private Studio accounts. New users sign in with a one-time setup code and choose a password.",
			username: "Username",
		...
		dialog: {
			title: "Settings",
			description:
				"Manage the Helix workspace, runtime, identity, and access boundaries.",
		...
		keyboardShortcuts: {
			...
			actions: {
				...
				logOut: {
					label: "Log out",
					description: "Sign out of Helix Harness",
				},
				approveToolRequest: {
		...
		debugging: {
			...
			exportTooOld:
				"The running Helix backend is too old to export logs. Update it and restart.",
			exportForbidden:
				"Downloading all logs needs a signed-in Studio session. An API key is not enough.",
		...
		voice: {
			...
			dictation: {
				...
				micAccessBlocked:
					"Microphone access was blocked. Allow microphone access for this Helix page, then try again.",
		...
		general: {
			title: "General",
			description: "Core workspace behavior and Helix runtime defaults.",
			account: "Account",
			...
			password: "Password",
			passwordDescription: "Change the password for this Helix account.",
			passwordDialog: {
				...
				setDescription:
					"Choose the password remote browsers sign in with as unsloth (at least {minLength} characters). Helix Harness keeps signing in automatically.",
			...
			modelAutoSwitch: {
				...
				apiOnlyDescription:
					"Idle unload leaves a model you loaded from Helix in memory, and frees only the ones an API request loaded.",
			},
			previewSharing: {
			...
			permissions: {
				...
				bypassDescription:
					"How Helix authorizes chat tool calls (terminal, python, web, MCP) before they run. Full access disables approvals and the code sandbox.",
			},
			notifications: {
			...
			startup: {
				...
				launchAtLogin: "Run Helix Harness at login",
				launchAtLoginDescription:
					"Start Helix Harness in the background when you log in. It stays in the menu bar or system tray until you open it.",

				closeToTray: "Close to system tray",
				closeToTrayDescription:
					"Keep Helix Harness and its local runtime running when you close the main window.",
			...
			resetPreferences: {
				...
				confirmDescription:
					"Clears local-only preferences and reloads Helix Harness. Chats, API access, and DB-backed settings are kept.",
				confirmAction: "Reset and reload",
			},
		},
		profile: {
			title: "Profile & memory identity",
			description: "How Helix identifies and addresses you in this account.",
			changePicture: "Change profile picture",
			uploadPhoto: "Upload photo",
			removePhoto: "Remove",
			pictureOptions: "Profile picture options",
			displayName: "Display name",
			nickname: "What should Helix call you?",
			...
			stats: {
				title: "Your stats",
				subtitle:
					"Everything below is counted from your own history. Nothing is sent to Helix or Unsloth.",
				retry: "Try again",
				privacyNote:
					"Stats are computed from local chat, API usage, and training history held by this Helix installation. API prompts, responses, and keys are never stored for stats. Nothing is sent to Helix, Unsloth, or any third party.",
				emptyChats:
				...
				studioChatTokens: "Helix Chat tokens",
		...
		appearance: {
			title: "Appearance",
			description: "How Helix Harness looks on this device.",
			theme: {
				title: "Theme",
				label: "Color scheme",
			...
			palette: {
				label: "Color palette",
				description:
					"Colors used across Helix Harness, in light and dark mode. Glass supports real transparency.",
				standard: "Standard",
				classic: "Classic",
				minimal: "Minimal",
				glass: "Neutral glass",
				...
				balanced: "Balanced",
				airy: "Airy",
				advancedMaterials: "Advanced material controls",
				sidebarSurface: "Sidebar",
				chatSurface: "Chat surface",
				composerSurface: "Composer",
				rightRailSurface: "Right rail",
				mainTransparency: "Main background transparency",
				opacity: "Glass opacity",
				opacityDescription:
					"How solid frosted surfaces are. Lower is more see-through.",
				blur: "Glass blur",
				blurDescription: "Frost strength on sidebar, cards, and the composer.",
			},
			custom: {
				reset: "Reset",
				...
				uiFontSize: {
					label: "UI font size",
					description: "Adjust the base size used for the Helix workspace.",
				},
				codeFontSize: {
			...
			language: {
				...
				description: "The language used by Helix Harness.",
		...
		resources: {
			...
			description:
				"Monitor the Helix runtime, resident models, hardware, and storage.",
			...
			llamaBackend: {
				...
				unsupported: {
					...
					localLink:
					"llama.cpp is a local directory you linked yourself, so Helix will not replace it.",
					sourceBuild:
		...
		agents: {
			title: "Agent bridges",
			description:
				"Connect coding agents such as Claude Code and Codex to a Helix-served local model with unsloth start.",
			intro:
				"Helix bridges Claude Code, Codex, DeepSeek Harness, Hermes, OpenClaw, OpenCode, and other agents to a locally served model. The compatible Unsloth CLI/runtime stays underneath; Helix owns the workspace and does not rewrite an agent's config files.",
			...
			automaticSettingsNote:
				"The underlying Unsloth runtime applies the model’s recommended settings if you have not set any flags.",
			configurationNote:
				"You can also adjust any configuration. See further below or",
			configurationDocs: "docs",
			configurationFlagsSuffix: "for flags.",
			modelNote:
				"Codex requires a GGUF model served by llama-server. Other agents can also use transformer-backed models; remove --model to use the model already loaded in Helix.",
			subagent: {
				title: "Use a local model as a subagent",
				description:
					"Keep {agent} on its current model and delegate selected tasks to this local Helix model.",
			...
			quickstart: {
				...
				description:
					"Launch an agent against the model currently loaded in Helix. Load a model first, then swap claude for any supported agent below.",
			...
			options: {
				...
				model:
					"Select a model. Without --model, unsloth start uses the model currently loaded in Helix and errors if none is loaded.",
				contextLength:
				...
				persist: "Keep Helix-managed agent storage between runs.",
				asSubagent:
					"Keep the parent on its current model and register Helix as a local subagent (Claude Code, Codex, and OpenCode).",
			...
			remote: {
				title: "Connect to a remote Helix runtime",
				description:
					"Point unsloth start at a compatible Helix/Unsloth runtime running elsewhere by setting these before launching (or pass --api-key directly):",
			},
			passthrough: {
		...
		chat: {
			...
			pastedTextThresholdDescription:
				"Pasted text longer than this becomes a .txt attachment instead of filling the message box. Press {shortcut} to paste into the message box anyway.",
			...
			webSearch: {
				...
				imagesDescription:
					"Let web search return pictures, and fetch one for each thing an answer lists. Thumbnails are downloaded and resized by the Helix backend, so the browser never contacts image hosts.",
			},
			artifacts: {
				title: "Canvas",
		...
		connections: {
			...
			description: "Manage model endpoints and external provider connections.",
		},
		remoteLan: {
			title: "Remote access",
			description:
				"Reach this Helix runtime from your other devices over your local network or a temporary public URL.",
		},
		apiKeys: {
			title: "API access",
			description:
				"Access the Helix model runtime through its OpenAI-compatible API.",
			...
			secureHttpsHint:
				"The 0.0.0.0 port is still reachable globally. For full security, launch the compatible runtime with --secure to expose only this HTTPS link.",
		...
		about: {
			title: "About Helix Harness",
			description:
				"Build identity, upstream lineage, documentation, and diagnostics.",
			studioVersion: "Helix Backend Version",
			...
			license: {
				...
				studioLabel: "Helix Harness",
				studioLicense: "AGPL-3.0",
				studioDescription:
					"Helix application and control-plane source under the GNU AGPL v3.0.",
				libraryLabel: "Unsloth Core",
				libraryLicense: "Apache-2.0",
				libraryDescription: "Licensed under Apache 2.0.",
			},
			dangerZone: "Danger zone",
			shutDownStudio: "Shut down Helix Harness",
			shutDownStudioDescription:
				"Stops the Helix backend and ends your session.",
			shutDown: "Shut down",
			update: {
				title: "Update Helix Harness",
				commandText: "{label} text",
				copied: "Copied",
				copyCommand: "Copy command",
				commandCopied: "{label} copied",
				copyNamedCommand: "Copy {label}",
				checkingInstall: "Checking how the Helix runtime was installed...",
				installIntro:
					"To install or update the compatible Helix/Unsloth runtime:",
				...
				restartAfterUpdate: "Restart Helix Harness after updating.",
				desktopManaged:
				...
				desktopCurrentDescription:
					"Helix Harness will continue checking automatically.",
				...
				unknownInstall:
					"Could not detect how the compatible runtime was installed. For installer or PyPI installs, use the commands above.",
				localCheckout:
	...
	studio: {
		...
		training: {
			...
			startUnconfirmed:
				"Helix couldn't confirm whether training started. Checking status in the background.",
		...
		trainingStart: {
			...
			terminalStart: "> Helix training starts...",
	...
	skills: {
		...
		refresh: "Refresh",
		empty:
			"No Agent Skills found. Add a SKILL.md folder under ~/.agents/skills or ~/.claude/skills, then refresh.",
		sourceAgents: "Agents",
		sourceClaude: "Claude",
