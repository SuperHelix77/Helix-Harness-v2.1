...
export const ja = {
	...
	settings: {
		groups: {
			workspace: "ワークスペース",
			identityData: "ID とデータ",
			runtimeAccess: "ランタイムとアクセス",
			support: "サポート",
		},
		accounts: {
			title: "アカウント",
			description:
				"個別の Studio アカウントを作成します。新しいユーザーは一度きりのセットアップコードでサインインし、パスワードを設定します。",
			username: "ユーザー名",
			create: "アカウントを作成",
			setupCode: "セットアップコード",
			setupFor: "{username} のセットアップコード",
			shownOnce:
				"このコードを今すぐコピーしてアカウントの持ち主に渡してください。ここにしか表示されず、60 分以内に一度だけ使えます。",
			expires: "有効期限: {expiry}",
			copy: "セットアップコードをコピー",
			copied: "コピーしました",
			copyFailed:
				"コピーできませんでした。上のセットアップコードを選択してコピーしてください。",
			dismiss: "完了",
			owner: "インストールの所有者",
			active: "有効",
			inactive: "無効",
			...
			resetDescription:
				"セットアップコードを再発行すると {username} のパスワードが置き換えられ、セッションは終了し、API キーは失効します。新しいコードを渡して、もう一度パスワードを選んでもらってください。",
			deactivate: "無効化",
			reactivate: "再有効化",
			delete: "アカウントを削除",
			deleteTitle: "{username} を削除しますか?",
			deleteDescription:
				"{username} のセッションを取り消し、実行中の作業をキャンセルします。チャット、設定、認証情報、アップロード、データセット、学習の実行、出力、エクスポート、ギャラリー、サンドボックス、プロジェクト、一時ファイルは退避されます。ディレクトリは名前を変えて脇に置かれ、削除はされません。同じユーザー名を再び作成すると、これらのデータを持たない新しいアカウントになります。",
			cancel: "キャンセル",
			retry: "アカウントを再読み込み",
		...
		keyboardShortcuts: {
			...
			needsModifier:
				"⌘、Ctrl、Alt のいずれかを加えてください。単独のキーでは入力を奪ってしまいます。",
			conflict: "別のショートカットでも使われています",
			conflictShadowed:
				"この組み合わせは別のショートカットのもので、そちらが実行されます",
			edit: "ショートカットを変更",
			clear: "ショートカットを削除",
			reset: "既定値に戻す",
			resetAll: "すべて既定値に戻す",
			...
			actions: {
				...
				togglePinChat: {
					label: "ピン留めの切り替え",
					description:
						"選択中のチャット、なければ現在のチャットをピン留め、または解除します",
				},
				selectAllChats: {
					label: "すべてのチャットを選択",
				...
				copyChatAsMarkdown: {
					...
					description:
						"チャット全体を Markdown としてクリップボードにコピーします",
				},
				copySessionId: {
					label: "セッション ID をコピー",
					description:
						"このチャットのサンドボックスのセッション ID をコピーします",
				},
			},
		},
		debugging: {
			...
			source: "ログファイル",
			sourceHint:
				"モデルランナーはそれぞれ独自のログを書き出すため、読み込みや生成の失敗の理由は、サーバーログではなくそちらに記録されていることがよくあります。",
			path: "場所",
			pathCopy: "パスをコピー",
			refreshSection: "更新",
			mode: "モード",
			...
			refreshNow: "今すぐ更新",
			privacyNote:
				"この表示では認証情報をマスクしています。ディスク上のファイルはマスクされません。",
			copyVisible: "表示中のログをコピー",
			empty: "まだ何も記録されていません。",
			disabled:
				"ファイルへのログ出力は無効です (UNSLOTH_STUDIO_NO_FILE_LOG=1)。",
			missing: "ログファイルが見つかりませんでした。",
			unreadable: "ログファイルを読み取れませんでした。",
			timeout:
				"ログの取得がタイムアウトしました。サーバーに接続できない可能性があります。",
			droppedNotice:
				"一部の行がスキップされました。ログの書き込みが読み取りに追いつきませんでした。",
			morePending: "さらに行を読み込み中です。次回の更新時に表示されます。",
			staleSession:
				"ファイルへのログ出力が無効なため、これは以前のセッションであり更新されません。",
			downloadAllLogs: "すべてのログをダウンロード (.zip)",
			downloadingAllLogs: "ログをまとめています...",
			exportMaskedNote:
				"書き出したファイルでは認証情報をマスクします。非常に大きなログは直近の行だけを残し、一部のログはまったく含まれないことがあります。アーカイブ内の EXPORT_WARNINGS.txt を確認してください。",
			...
			exportTooOld:
				"実行中の Unsloth バックエンドが古すぎるため、ログを書き出せません。バックエンドを更新して再起動してください。",
			exportForbidden:
				"すべてのログをダウンロードするには、サインイン済みの Studio セッションが必要です。API キーだけでは実行できません。",
			keywords:
				"デバッグ ログ エラー クラッシュ トレースバック スタックトレース 診断 障害 調査 debug log logs error",
		},
		voice: {
			title: "音声",
		...
		general: {
			...
			passwordDialog: {
				...
				setDescription:
					"リモートのブラウザーが unsloth としてサインインするためのパスワード（最低 {minLength} 文字）を選んでください。Unsloth デスクトップアプリは引き続き自動でサインインします。",
				setSubmit: "パスワードを設定",
				setting: "設定中...",
			...
			modelAutoSwitch: {
				...
				idleNeedsEnable:
					"アンロードされたモデルが次回使用時に再読み込みされるように、「リクエストごとにモデルを切り替え」をオンにしてください。",
				idleActiveViaEnv:
					"アイドル時の自動アンロードは UNSLOTH_MODEL_IDLE_TTL 環境変数によって有効になっています。",
				loadError: "モデル自動切り替え設定の読み込みに失敗しました。",
				saveError: "モデル自動切り替え設定の保存に失敗しました。",
				idleError:
					"モデルを読み込んだままにするには 0 を、それ以外は 60 秒以上を入力してください。",
				...
				keepKv:
					"アイドル時の自動アンロードをまたいでチャットのコンテキストを保持",
				keepKvDescription:
			...
			notifications: {
				...
				showLoadedModelsDescription:
					"現在メモリ上にあるすべてのモデル（チャット、音声、画像、動画）を一覧表示する小さなカードを右下に表示します。各モデルを解放するボタンが付いています。",
			},
			startup: {
				sectionTitle: "起動",
			...
			downloads: {
				...
				xetMissing:
					"hf_xet がインストールされていないため Xet は利用できません。",
			},
			uploads: {
				sectionTitle: "アップロード",
			...
			rag: {
				...
				embeddingModelDescription:
					"ドキュメントのインデックス作成と検索に使用する Hugging Face モデルまたはローカルパス。デフォルトは {defaultModel} です。",
				searchPlaceholder: "HF 上の任意のモデルを検索",
				reindexWarning:
					"新しくインデックスされるドキュメントにのみ影響します。モデルを変更した後は、既存のドキュメントを再アップロードしてください。",
				emptyError:
					"Hugging Face モデル ID またはローカルパスを入力してください。",
				...
				downloadingDescription:
					"進捗はダウンロードパネルに表示されます。完了後にインデックス作成で使用されます。",
		...
		appearance: {
			...
			palette: {
				...
				balanced: "バランス",
				airy: "エアリー",
				advancedMaterials: "詳細なマテリアル設定",
				sidebarSurface: "サイドバー",
				chatSurface: "チャット面",
				composerSurface: "入力欄",
				rightRailSurface: "右パネル",
				mainTransparency: "メイン背景の透明度",
				opacity: "ガラスの不透明度",
				opacityDescription: "すりガラス面の不透明さ。低いほど透けて見えます。",
				blur: "ガラスのぼかし",
				blurDescription: "サイドバー、カード、入力欄のすりガラス効果の強さ。",
			},
			custom: {
				reset: "リセット",
				...
				importFont: {
					...
					scanFolder: "フォルダを選択",
					alreadyAvailable:
						"このフォントは既に利用可能なため、既存のものを使用します。",
					folderNoFonts:
						"そのフォルダにフォントファイルが見つかりませんでした。",
					remove: "削除",
					errorInvalidType:
					...
					errorStorageFull:
						"ローカルストレージの空き容量が足りません。先にインポート済みフォントを削除してください。",
		...
		resources: {
			title: "システム",
			description:
				"この Unsloth サーバーのハードウェアとストレージを監視します。",
			...
			llamaBackend: {
				...
				applying: "インストール中...",
				applyHint:
					"新しいビルドをダウンロードして llama.cpp を再起動します。ロード中のモデルはアンロードされます。",
				applyHintWithSize:
					"{size} をダウンロードして llama.cpp を再起動します。ロード中のモデルはアンロードされます。",
				...
				envLocked:
					"環境変数 UNSLOTH_LLAMA_CPP_BACKEND により {backend} に固定されています。この設定より優先されます。",
				customPath: {
					...
					automatic: "自動（同梱）",
					bundled:
						"Unsloth がインストールした llama.cpp ランタイムを使用します。",
					active:
						"次回のモデル読み込みからカスタム llama-server が使用されます。",
					environmentManaged: "環境変数 {variable} によって管理されています。",
					missingBinary:
						"このフォルダーでは llama-server を利用できなくなりました。別のフォルダーを選ぶか、同梱ランタイムを使用してください。",
					reloadRequired:
						"選択した llama-server を使用するにはモデルを再読み込みしてください。",
					change: "変更",
					saving: "保存中...",
					useBundled: "同梱版を使用",
				...
				unsupported: {
					notInstalled:
						"管理対象の llama.cpp インストールが見つからないため、切り替えるバックエンドがありません。",
					localLink:
						"llama.cpp は自分でリンクしたローカルディレクトリのため、Unsloth は置き換えません。",
					sourceBuild:
						"この llama.cpp はソースからビルドされているため、ここではバックエンドを切り替えられません。",
					customPath:
						"カスタム llama.cpp フォルダーが選択されています。そのビルドによって計算バックエンドが決まります。",
					unresolved:
						"利用可能なバックエンドを確認できませんでした。接続を確認して再試行してください。",
				},
				// 非表示: 設定検索用の追加キーワード。
			...
			modelMemory: {
				...
				keepResidentHint:
					"モデルがロードされている間、重みをシステム RAM に戻しません。アイドル時の自動アンロードを無効にし、重みが実際にホスト RAM 上にある場合（ユニファイドメモリ、または GPU への部分オフロード）は --mlock も渡すため、OS が重みをページアウトして次のプロンプトで再アップロードすることがなくなります。",
				noRamReserve: "モデル用にシステム RAM を確保しない",
				noRamReserveDescription: "モデルの重みが占有する RAM を減らします。",
				noRamReserveHint:
					"モデルが GPU に完全にオフロードされている場合、対応する Windows ビルドではメモリマップ読み込みを行わず、ファイルのページが常駐しないようにします。それ以外ではメモリマップ読み込みを維持します。必要な CPU バッファは RAM を使用することがあります。--no-mmap と --mlock を除去します。",
				mlockVetoed:
					"--mlock は無効のままです。モデルを固定するとモデル全体分の RAM を確保することになります。アイドル時の自動アンロードは引き続き無効です。",
				memlockCapped:
					"このシステムはロック可能なメモリを {limit} に制限しています。これより大きいモデルは完全には固定されません。ulimit -l で上限を引き上げてください。",
				reloadRequired:
					"新しいメモリ設定を適用するにはモデルを再読み込みしてください。",
			...
			storage: {
				...
				modelsFolderHint:
					"ダウンロードしたモデルの保存場所です。システムドライブを圧迫しないよう変更できます。新規ダウンロードにのみ適用され、既存のモデルはそのままの場所に残ります。",
				openAction: "開く",
				copyAction: "パスをコピー",
				copied: "パスをコピーしました",
				openError: "フォルダを開けませんでした",
		...
		agents: {
			...
			options: {
				...
				loadIn4bit: "Hugging Face モデルの 4bit 読み込みを切り替えます。",
				...
				yolo: "承認の確認をスキップします。信頼できる環境でのみ使用してください。",
			},
			remote: {
		...
		chat: {
			...
			pastedTextThresholdDescription:
				"この長さを超える貼り付けテキストは、入力欄を埋める代わりに .txt 添付ファイルになります。 {shortcut} を押すと、それでも入力欄に貼り付けます。",
			...
			artifacts: {
				...
				blockedBanner:
					"{hosts} からの外部リソース {count} 件をブロックしました。",
				blockedBannerPlural:
					"{hosts} からの外部リソース {count} 件をブロックしました。",
			...
			importChatsDescription:
				"Open WebUI、JSONL、NDJSON、または CSV のエクスポートファイルを履歴にインポートします。",
			...
			importingChats:
				"チャットをインポート中: 現在 {count} 件（{percent}%）...",
			importedChatCountPartial:
				"{count} 件の会話を最近のチャットにインポートしました。{failed} 件は保存できませんでした。",
		...
		apiKeys: {
			...
			secureHttpsHint:
				"0.0.0.0 ポートは依然としてグローバルにアクセス可能です。完全なセキュリティを確保するには、Unsloth を --secure 付きで起動し、この HTTPS リンクのみを公開してください。",
			...
			codingAgentsHint:
				"このサーバーに対してコーディングエージェントを起動します。読み込み済みのモデルを使用します。ローカルサーバーでは API キーが自動的に発行され、リモートサーバーではコマンドに含まれます。",
			codingAgentsSwap:
				"claude を codex、openclaw、opencode、hermes に置き換えられます。",
	...
	studio: {
		...
		wizard: {
			...
			methodTooltip:
				"モデルの学習方法です。LoRA と QLoRA はすべての重みではなく小さなアダプターを更新します。",
		...
		modelPicker: {
			...
			reasonNotTrainable: "このデバイス上のモデルはトレーニングできません。",
		...
		methods: {
			...
			full: {
				label: "フルファインチューニング",
				hint: "すべての重みをトレーニングします。最高品質ですが、最も多くの VRAM が必要です。",
				note: "fp16",
			},
			cpt: {
				label: "継続事前学習",
		...
		dataset: {
			...
			uploadDetailsTooltip:
				"1ファイルあたり最大 {limit}。PDF、DOCX、TXT はそのままではトレーニング用データセットとして使用できないため、先にレシピで変換してください。",
		...
		params: {
			...
			alpha: "Alpha",
			alphaTooltip:
				"LoRA 更新のスケール係数。通常は rank の 2 倍に設定します。",
			dropout: "Dropout",
			dropoutTooltip:
			...
			doraNeedsVisionLayersOff:
				"DoRA を使うにはビジョンレイヤーの学習をオフにしてください",
			optimization: "最適化",
			schedule: "スケジュール",
			memory: "メモリ",
			optimizer: "オプティマイザー",
			...
			optimizerTooltipMlx:
				"最適化アルゴリズム。デフォルトは AdamW です。Lion はメモリ使用量を抑えられますが、通常はより低い学習率が必要です。",
			...
			evalSteps: "評価ステップ間隔",
			evalStepsTooltip:
				"評価を行う間隔を、総トレーニングステップに対する割合 (0-1) で指定します。0 に設定すると評価が無効になります。例: 0.01 = ステップの 1% ごとに評価を実行。",
			seed: "シード値",
		...
		training: {
			...
			validation: {
				...
				hfDatasetRequired: "先に Hugging Face データセットを選択してください。",
				hfDatasetSplitRequired: "先に学習用分割を選択または入力してください。",
	...
	modelMemory: {
		...
		tooLarge:
			"VRAM を超えるため CPU にオフロードされます。より小さい量子化の方が高速です",
	},
	skills: {
		title: "エージェントスキル",
		description:
			"スキルは標準のエージェントフォルダーから検出されます。ここで有効にし、チャットで @ を入力して呼び出します。",
		precedence: "~/.agents/skills は ~/.claude/skills より優先されます。",
		refresh: "更新",
		empty:
			"エージェントスキルが見つかりません。~/.agents/skills または ~/.claude/skills に SKILL.md のフォルダーを追加して更新してください。",
		sourceAgents: "Agents",
		sourceClaude: "Claude",
		sourceBundled: "同梱",
		shadowed: "上書き",
