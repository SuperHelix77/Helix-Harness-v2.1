...
export const ptBR = {
	picker: {
		...
		offlineBody: "Mude para Dispositivo para usar {noun} locais ou em cache.",
		...
		rateLimitedBody: "Aguarde um momento e tente buscar {noun} novamente.",
		hfToken: {
			label: "Token do HF",
			saved: "Salvo",
			add: "Adicionar",
	...
	shell: {
		...
		selection: {
			...
			deleteDescription:
				"Excluir {count} conversas? Esta ação não pode ser desfeita.",
	...
	settings: {
		groups: {
			...
			identityData: "Identidade e dados",
			runtimeAccess: "Runtime e acesso",
			support: "Suporte",
		},
		accounts: {
			title: "Contas",
			description:
				"Crie contas privadas do Studio. Novos usuários entram com um código de configuração de uso único e escolhem uma senha.",
			username: "Nome de usuário",
			create: "Criar conta",
			setupCode: "Código de configuração",
			setupFor: "Código de configuração para {username}",
			shownOnce:
				"Copie este código agora e compartilhe com o titular da conta. Ele é mostrado apenas aqui e pode ser usado uma vez em até 60 minutos.",
			expires: "Expira {expiry}",
			copy: "Copiar código de configuração",
			copied: "Copiado",
			copyFailed:
				"Não foi possível copiar. Selecione e copie o código de configuração acima.",
			dismiss: "Concluído",
			...
			resetDescription:
				"Gerar um novo código de configuração substitui a senha de {username}, encerra as sessões dela e revoga suas chaves de API. Entregue o novo código para que ela escolha outra senha.",
			deactivate: "Desativar",
			reactivate: "Reativar",
			delete: "Excluir conta",
			deleteTitle: "Excluir {username}?",
			deleteDescription:
				"Isso revoga as sessões de {username} e cancela o trabalho em andamento. Chats, configurações, credenciais, uploads, conjuntos de dados, treinamentos, saídas, exportações, galerias, sandboxes, projetos e arquivos temporários são retirados. Os diretórios são renomeados à parte, nunca excluídos. Criar este nome de usuário novamente inicia uma conta nova sem nenhum desses dados.",
			cancel: "Cancelar",
		...
		keyboardShortcuts: {
			...
			needsModifier:
				"Adicione ⌘, Ctrl ou Alt. Uma tecla sozinha engoliria a digitação.",
			conflict: "Também usado por outro atalho",
			conflictShadowed:
				"Outro atalho tem essa combinação e é executado no lugar dele",
			edit: "Alterar atalho",
			...
			actions: {
				...
				markChatUnread: {
					...
					description:
						"Marcar como não lidos os chats selecionados ou o chat atual",
				},
				togglePinChat: {
					label: "Alternar fixação",
					description:
						"Fixar ou desafixar os chats selecionados ou o chat atual",
				},
				selectAllChats: {
				...
				copyChatAsMarkdown: {
					...
					description:
						"Copiar todo o chat para a área de transferência como Markdown",
				},
				copySessionId: {
		...
		debugging: {
			...
			sourceHint:
				"Os executores de modelos gravam os próprios logs, então uma falha ao carregar ou ao gerar costuma ser explicada ali, e não no log do servidor.",
			path: "Local",
			...
			privacyNote:
				"As credenciais são mascaradas nesta visualização. No arquivo em disco elas não são mascaradas.",
			copyVisible: "Copiar log visível",
			empty: "Nada foi registrado ainda.",
			disabled:
				"O log em arquivo está desativado (UNSLOTH_STUDIO_NO_FILE_LOG=1).",
			missing: "Nenhum arquivo de log foi encontrado.",
			unreadable: "Não foi possível ler o arquivo de log.",
			timeout:
				"A solicitacao do registro expirou. O servidor pode estar inacessivel.",
			droppedNotice:
				"Algumas linhas foram ignoradas: o log foi gravado mais rápido do que era possível ler.",
			morePending:
				"Mais linhas ainda estao sendo lidas; elas chegam na proxima atualizacao.",
			staleSession:
				"O registro em arquivo esta desativado, portanto esta e uma sessao anterior e nao sera atualizada.",
			downloadAllLogs: "Baixar todos os logs (.zip)",
			downloadingAllLogs: "Compactando os logs...",
			exportMaskedNote:
				"As credenciais são mascaradas nos arquivos exportados. Logs muito grandes mantêm apenas as linhas mais recentes, e alguns podem ficar de fora por completo; veja EXPORT_WARNINGS.txt no arquivo.",
			...
			exportTooOld:
				"O backend do Unsloth em execução é antigo demais para exportar os logs. Atualize esse backend e reinicie.",
			exportForbidden:
				"Para baixar todos os logs é preciso uma sessão do Studio conectada. Uma chave de API não basta.",
			keywords:
				"depuracao depurar registro registros log logs erro erros falha rastreamento diagnostico solucao de problemas debug",
		},
		voice: {
			title: "Voz",
			description:
				"Microfone, ditado, conversão de fala em texto e leitura em voz alta",
			dictation: {
				sectionTitle: "Ditado",
				...
				sttDownloadStatusFailed:
					"Não foi possível verificar o status do download",
				sttDownload: "Baixar",
		...
		general: {
			...
			downloads: {
				...
				xetMissing:
					"O Xet está indisponível porque o hf_xet não está instalado.",
			},
			uploads: {
		...
		profile: {
			...
			stats: {
				...
				trainingDescription:
					"Execuções de fine-tuning deste espaço de trabalho",
		...
		appearance: {
			...
			palette: {
				...
				minimal: "Minimalista",
				glass: "Vidro neutro",
				materialPresets: "Predefinições de material",
				opaque: "Opaco",
				balanced: "Equilibrado",
				airy: "Arejado",
				advancedMaterials: "Controles avançados de material",
				sidebarSurface: "Barra lateral",
				chatSurface: "Superfície do chat",
				composerSurface: "Compositor",
				rightRailSurface: "Painel direito",
				mainTransparency: "Transparência do fundo principal",
				opacity: "Opacidade do vidro",
				opacityDescription:
					"Define o quanto as superfícies foscas são sólidas. Valores menores deixam mais transparente.",
				blur: "Desfoque do vidro",
				blurDescription:
					"Intensidade do efeito fosco na barra lateral, nos cartões e no compositor.",
			},
			custom: {
				reset: "Redefinir",
		...
		resources: {
			...
			llamaBackend: {
				...
				customPath: {
					...
					active:
						"Seu llama-server personalizado será usado no próximo carregamento de modelo.",
					environmentManaged:
						"Gerenciado pela variável de ambiente {variable}.",
					missingBinary:
						"O llama-server não está mais disponível nesta pasta. Escolha outra pasta ou use o runtime incluído.",
					reloadRequired:
						"Recarregue o modelo para usar o llama-server selecionado.",
					change: "Alterar",
					saving: "Salvando...",
				...
				unsupported: {
					...
					customPath:
						"Uma pasta personalizada do llama.cpp está selecionada. A compilação dela determina o backend de computação.",
					unresolved:
			...
			modelMemory: {
				...
				keepResidentHint:
					"Não devolve os pesos à RAM do sistema enquanto o modelo continuar carregado. Desativa a descarga automática por inatividade e, quando os pesos de fato ficam na RAM do host (memória unificada ou offload parcial para a GPU), também passa --mlock, para que o sistema operacional não os pagine e os reenvie no próximo prompt.",
				noRamReserve: "Não reservar RAM do sistema para o modelo",
				noRamReserveDescription: "Reduz a RAM ocupada pelos pesos do modelo.",
				noRamReserveHint:
					"Ignora o carregamento mapeado em memória nas versões compatíveis do Windows quando o modelo está totalmente descarregado na GPU, para que suas páginas não fiquem residentes. Caso contrário, mantém o carregamento mapeado em memória. Buffers de CPU necessários ainda podem usar RAM. Remove --no-mmap e --mlock.",
				mlockVetoed:
					"--mlock continua desativado: fixar o modelo reservaria RAM para todo ele. A descarga automática por inatividade continua desativada.",
				memlockCapped:
					"Este sistema limita a memória bloqueada a {limit}. Um modelo maior não será totalmente fixado; aumente o limite com ulimit -l.",
				reloadRequired:
					"Recarregue o modelo para aplicar as novas opções de memória.",
			...
			storage: {
				...
				modelsFolderDescription: "Onde os modelos baixados são armazenados.",
				modelsFolderHint:
					"Onde os modelos baixados são armazenados. Altere para manter os modelos fora da sua unidade de sistema. Vale apenas para novos downloads. Os modelos que você já tem permanecem onde estão.",
				openAction: "Abrir",
				copyAction: "Copiar caminho",
				copied: "Caminho copiado",
				openError: "Não foi possível abrir a pasta",
		...
		chat: {
			...
			pastedTextThresholdDescription:
				"Texto colado maior que isso vira um anexo .txt em vez de encher a caixa de mensagem. Pressione {shortcut} para colar na caixa de mensagem mesmo assim.",
			...
			compactionStyleRolling5: "Descartar turnos antigos (~5% de espaço extra)",
			compactionStyleRollingNone: "Descartar turnos antigos (sem corte extra)",
			autoCompactKeywords:
			...
			importedChatCountPartial:
				"{count} conversas importadas para Recentes; {failed} não puderam ser salvas.",
		...
		data: {
			...
			archivedImagesDescription:
				"Veja e gerencie as imagens que você arquivou.",
			...
			archivedAudioDescription:
				"Veja e gerencie os clipes de áudio que você arquivou.",
		...
		apiKeys: {
			...
			codingAgentsSwap:
				"Troque claude por codex, openclaw, opencode ou hermes.",
	...
	studio: {
		...
		wizard: {
			...
			methodTooltip:
				"Como o modelo é treinado. LoRA e QLoRA atualizam adaptadores pequenos em vez de todos os pesos.",
		...
		dataset: {
			...
			streaming: {
				...
				blockers: {
					...
					trainOnCompletions: 'Desative "Apenas respostas do assistente".',
					evalSplit:
		...
		params: {
			...
			doraNeedsVisionLayersOff:
				"Desative o treinamento das camadas de visão para usar DoRA",
		...
		history: {
			...
			deleteArtifactsLabel: "Excluir também do disco os arquivos do adaptador",
	...
	modelMemory: {
		...
		tooLarge:
			"Maior que a VRAM, será descarregado para a CPU. Uma quantização menor roda mais rápido",
	},
	skills: {
		title: "Habilidades de agentes",
		description:
			"As habilidades são descobertas nas suas pastas padrão de agentes. Ative-as aqui e digite @ no chat para mencionar uma.",
		precedence: "~/.agents/skills tem precedência sobre ~/.claude/skills.",
		refresh: "Atualizar",
		empty:
			"Nenhuma habilidade encontrada. Adicione uma pasta com SKILL.md em ~/.agents/skills ou ~/.claude/skills e atualize.",
		sourceAgents: "Agents",
		sourceClaude: "Claude",
