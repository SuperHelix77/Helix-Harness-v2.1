...
export const de = {
	...
	shell: {
		find: {
			...
			truncated:
				"Diese Seite ist zu lang, um vollständig durchsucht zu werden.",
		},
		beta: "BETA",
		brand: "HELIX HARNESS",
		...
		navigation: {
			...
			audio: "Audio",
			trainChecking:
				"Dieser Rechner wird auf Trainingsunterstützung geprüft...",
		...
		selection: {
			...
			deleteDescription:
				"{count} Chats löschen? Das lässt sich nicht rückgängig machen.",
	...
	settings: {
		groups: {
			...
			identityData: "Identität und Daten",
			runtimeAccess: "Laufzeit und Zugriff",
			support: "Support",
		},
		accounts: {
			title: "Konten",
			description:
				"Private Studio-Konten anlegen. Neue Nutzer melden sich mit einem einmaligen Einrichtungscode an und wählen ein Passwort.",
			username: "Benutzername",
			create: "Konto anlegen",
			setupCode: "Einrichtungscode",
			setupFor: "Einrichtungscode für {username}",
			shownOnce:
				"Kopieren Sie diesen Code jetzt und geben Sie ihn an den Kontoinhaber weiter. Er wird nur hier angezeigt und kann innerhalb von 60 Minuten einmal verwendet werden.",
			expires: "Läuft ab: {expiry}",
			copy: "Einrichtungscode kopieren",
			copied: "Kopiert",
			copyFailed:
				"Kopieren nicht möglich. Markieren und kopieren Sie den Einrichtungscode oben.",
			dismiss: "Fertig",
			...
			resetDescription:
				"Ein neu erstellter Einrichtungscode ersetzt das Passwort von {username}, meldet die Person ab und widerruft ihre API-Schlüssel. Geben Sie ihr den neuen Code, damit sie wieder ein Passwort wählen kann.",
			deactivate: "Deaktivieren",
			reactivate: "Reaktivieren",
			delete: "Konto löschen",
			deleteTitle: "{username} löschen?",
			deleteDescription:
				"Dadurch werden die Sitzungen von {username} widerrufen und laufende Arbeiten abgebrochen. Chats, Einstellungen, Zugangsdaten, Uploads, Datensätze, Trainingsläufe, Ausgaben, Exporte, Galerien, Sandboxes, Projekte und temporäre Dateien werden stillgelegt. Verzeichnisse werden beiseite umbenannt, nie gelöscht. Wird dieser Benutzername erneut angelegt, beginnt ein neues Konto ohne diese Daten.",
			cancel: "Abbrechen",
		...
		keyboardShortcuts: {
			...
			needsModifier:
				"⌘, Strg oder Alt hinzufügen. Eine einzelne Taste würde die Eingabe verschlucken.",
			conflict: "Wird auch von einem anderen Kürzel verwendet",
			conflictShadowed:
				"Ein anderes Kürzel belegt diese Kombination und läuft stattdessen",
			edit: "Kürzel ändern",
			...
			actions: {
				...
				newTemporaryChat: {
					...
					description:
						"Einen Chat starten, der nicht im Verlauf gespeichert wird",
				},
				newStandaloneChat: {
				...
				archiveChat: {
					...
					description:
						"Die ausgewählten Chats archivieren, sonst den aktuellen",
				},
				markChatUnread: {
					label: "Als ungelesen markieren",
					description:
						"Die ausgewählten Chats als ungelesen markieren, sonst den aktuellen",
				},
				togglePinChat: {
					label: "Anheften umschalten",
					description:
						"Die ausgewählten Chats anheften oder lösen, sonst den aktuellen",
				},
				selectAllChats: {
				...
				clearChatSelection: {
					...
					description:
						"Die ausgewählten Chats abwählen. Escape hebt sie ebenfalls auf",
				},
				deleteSelectedChats: {
				...
				nextChatNeedingAttention: {
					...
					description:
						"Zum nächsten generierenden, wartenden oder ungelesenen Chat wechseln",
				},
				clearAllUnreads: {
				...
				openProjectPicker: {
					...
					description:
						"Über die Chat-Kopfzeile zu einem anderen Projekt wechseln",
				},
				startDictation: {
					label: "Diktat",
				...
				copyChatAsMarkdown: {
					...
					description:
						"Den gesamten Chat als Markdown in die Zwischenablage kopieren",
				},
				copySessionId: {
		...
		debugging: {
			...
			sourceHint:
				"Die Modell-Runner schreiben eigene Protokolle. Ein fehlgeschlagener Ladevorgang oder eine fehlgeschlagene Generierung wird deshalb oft dort erklärt und nicht im Server-Protokoll.",
			path: "Speicherort",
			...
			privacyNote:
				"Zugangsdaten werden in dieser Ansicht maskiert. In der Datei auf dem Datenträger sind sie nicht maskiert.",
			copyVisible: "Sichtbares Protokoll kopieren",
			empty: "Es wurde noch nichts protokolliert.",
			disabled:
				"Die Protokollierung in eine Datei ist deaktiviert (UNSLOTH_STUDIO_NO_FILE_LOG=1).",
			missing: "Es wurde keine Protokolldatei gefunden.",
			unreadable: "Die Protokolldatei konnte nicht gelesen werden.",
			timeout:
				"Die Protokollanfrage hat das Zeitlimit uberschritten. Der Server ist moglicherweise nicht erreichbar.",
			droppedNotice:
				"Einige Zeilen wurden übersprungen: Das Protokoll wurde schneller geschrieben, als es gelesen werden konnte.",
			morePending:
				"Weitere Zeilen werden noch gelesen; sie erscheinen bei der nachsten Aktualisierung.",
			staleSession:
				"Die Protokollierung in Dateien ist deaktiviert, daher ist dies eine fruhere Sitzung und wird nicht aktualisiert.",
			downloadAllLogs: "Alle Protokolle herunterladen (.zip)",
			downloadingAllLogs: "Protokolle werden gepackt...",
			exportMaskedNote:
				"In den exportierten Dateien werden Zugangsdaten maskiert. Sehr große Logs behalten nur ihre neuesten Zeilen, und einzelne Logs können ganz fehlen; siehe EXPORT_WARNINGS.txt im Archiv.",
			...
			exportTooOld:
				"Das laufende Unsloth-Backend ist zu alt für den Protokollexport. Aktualisieren Sie dieses Backend und starten Sie es neu.",
			exportForbidden:
				"Zum Herunterladen aller Protokolle ist eine angemeldete Studio-Sitzung erforderlich. Ein API-Schlüssel genügt nicht.",
			keywords:
				"Fehlersuche Debugging Protokoll Protokolle Log Logs Fehler Absturz Stacktrace Diagnose Problembehebung debug",
		},
		voice: {
		...
		general: {
			...
			password: "Passwort",
			passwordDescription: "Ändern Sie das Passwort für dieses Unsloth-Konto.",
			passwordDialog: {
			...
			helperLlm: {
				...
				saveError: "Helfer-LLM-Einstellungen konnten nicht gespeichert werden.",
			},
			modelAutoSwitch: {
				...
				idleError:
					"Geben Sie 0 ein, um das Modell geladen zu halten, oder mindestens 60 Sekunden.",
		...
		appearance: {
			...
			palette: {
				label: "Farbpalette",
				description:
					"Farben, die in Unsloth im hellen und dunklen Modus verwendet werden.",
				standard: "Standard",
				classic: "Klassisch",
				minimal: "Minimal",
				glass: "Neutrales Glas",
				materialPresets: "Material-Voreinstellungen",
				opaque: "Deckend",
				balanced: "Ausgewogen",
				airy: "Luftig",
				advancedMaterials: "Erweiterte Materialsteuerung",
				sidebarSurface: "Seitenleiste",
				chatSurface: "Chatfläche",
				composerSurface: "Eingabefeld",
				rightRailSurface: "Rechte Leiste",
				mainTransparency: "Transparenz des Haupthintergrunds",
				opacity: "Glasdeckkraft",
				opacityDescription:
					"Wie deckend die Milchglasflächen sind. Niedrigere Werte sind transparenter.",
				blur: "Glasunschärfe",
				blurDescription:
					"Stärke des Milchglaseffekts in Seitenleiste, Karten und Eingabefeld.",
			},
			custom: {
				reset: "Zurücksetzen",
				...
				importFont: {
					...
					folderNoFonts:
						"In diesem Ordner wurden keine Schriftdateien gefunden.",
					remove: "Entfernen",
					errorInvalidType:
				...
				reduceMotion: {
					...
					description:
						"Animationen reduzieren oder Systemeinstellung übernehmen.",
					system: "System",
					on: "Ein",
					off: "Aus",
				},
		...
		resources: {
			...
			llamaBackend: {
				...
				applyHint:
					"Lädt den neuen Build herunter und startet llama.cpp neu. Ein geladenes Modell wird entladen.",
				applyHintWithSize:
					"Lädt {size} herunter und startet llama.cpp neu. Ein geladenes Modell wird entladen.",
				...
				envLocked:
					"Durch die Umgebungsvariable UNSLOTH_LLAMA_CPP_BACKEND auf {backend} festgelegt; sie überschreibt diese Einstellung.",
				customPath: {
					...
					active:
						"Dein eigener llama-server wird beim nächsten Laden eines Modells verwendet.",
					environmentManaged:
						"Wird durch die Umgebungsvariable {variable} verwaltet.",
					missingBinary:
						"llama-server ist in diesem Ordner nicht mehr verfügbar. Wähle einen anderen Ordner oder verwende die mitgelieferte Laufzeit.",
					reloadRequired:
						"Lade das Modell neu, um den ausgewählten llama-server zu verwenden.",
					change: "Ändern",
					saving: "Speichern...",
				...
				unsupported: {
					notInstalled:
						"Es wurde keine von Unsloth verwaltete llama.cpp-Installation gefunden, daher gibt es kein Backend zum Wechseln.",
					localLink:
						"llama.cpp ist ein selbst verknüpftes lokales Verzeichnis, das Unsloth nicht ersetzt.",
					sourceBuild:
						"Dieses llama.cpp wurde aus dem Quellcode gebaut; sein Backend lässt sich hier nicht wechseln.",
					customPath:
						"Ein benutzerdefinierter llama.cpp-Ordner ist ausgewählt. Dessen Build bestimmt das Compute-Backend.",
					unresolved:
						"Die verfügbaren Backends konnten nicht geprüft werden. Prüfe deine Verbindung und versuche es erneut.",
				},
			...
			modelMemory: {
				...
				noRamReserveHint:
					"Überspringt auf unterstützten Windows-Builds das speicherabgebildete Laden, wenn das Modell vollständig auf die GPU ausgelagert ist, sodass dessen Seiten nicht im Speicher gehalten werden. Andernfalls bleibt das speicherabgebildete Laden erhalten. Erforderliche CPU-Puffer können weiterhin RAM belegen. Entfernt --no-mmap und --mlock.",
				mlockVetoed:
					"--mlock bleibt aus: das Fixieren des Modells würde RAM für das gesamte Modell reservieren. Das automatische Entladen im Leerlauf bleibt deaktiviert.",
				memlockCapped:
					"Dieses System begrenzt gesperrten Speicher auf {limit}. Ein größeres Modell wird nicht vollständig fixiert; erhöhen Sie das Limit mit ulimit -l.",
				reloadRequired:
					"Modell neu laden, um die neuen Speicheroptionen anzuwenden.",
				loadError: "Modellspeicher-Einstellungen konnten nicht geladen werden",
				saveError:
					"Modellspeicher-Einstellungen konnten nicht gespeichert werden",
			...
			storage: {
				...
				modelsFolderDescription:
					"Wo heruntergeladene Modelle gespeichert werden.",
				modelsFolderHint:
					"Wo heruntergeladene Modelle gespeichert werden. Ändern Sie den Pfad, um Modelle von Ihrem Systemlaufwerk fernzuhalten. Gilt nur für neue Downloads. Bereits vorhandene Modelle bleiben, wo sie sind.",
		...
		agents: {
			...
			options: {
				...
				launch: "Startet den Agenten oder gibt nur Befehl und Umgebung aus.",
				persist:
				...
				yolo: "Überspringt Bestätigungsabfragen. Nur in vertrauenswürdigen Umgebungen verwenden.",
			},
			remote: {
		...
		chat: {
			...
			pastedTextThresholdDescription:
				"Eingefügter Text, der länger ist, wird zu einem .txt-Anhang, statt das Nachrichtenfeld zu füllen. Mit {shortcut} wird trotzdem in das Nachrichtenfeld eingefügt.",
			...
			currentDate: {
				...
				loadError:
					"Einstellungen zum aktuellen Datum konnten nicht geladen werden",
				saveError:
					"Einstellungen zum aktuellen Datum konnten nicht aktualisiert werden",
			},
			tools: {
			...
			artifacts: {
				...
				blockedBannerPlural:
					"{count} externe Ressourcen von {hosts} blockiert.",
			...
			importedChatCountPartial:
				"{count} Unterhaltungen in Zuletzt importiert; {failed} konnten nicht gespeichert werden.",
			...
			clearAllChatsDescription: "Löscht dauerhaft jeden Chat auf diesem Gerät.",
		...
		data: {
			...
			archivedImagesDescription:
				"Bilder anzeigen und verwalten, die du archiviert hast.",
			archivedVideos: "Archivierte Videos",
			archivedVideosDescription:
				"Videos anzeigen und verwalten, die du archiviert hast.",
			archivedAudio: "Archivierte Audioclips",
			archivedAudioDescription:
				"Audioclips anzeigen und verwalten, die du archiviert hast.",
		...
		about: {
			...
			update: {
				...
				desktopCheckingDescription: "Dies dauert in der Regel einige Sekunden.",
	...
	studio: {
		...
		wizard: {
			...
			methodTooltip:
				"Wie das Modell trainiert wird. LoRA und QLoRA aktualisieren kleine Adapter statt aller Gewichte.",
			...
			cachedModelGoneTitle: "Zwischengespeichertes Modell nicht mehr verfügbar",
		...
		modelPicker: {
			...
			devicePlaceholder:
				"Lokale Modelle suchen oder einen Ordnerpfad einfügen...",
			...
			reasonEmptyId:
				"Geben Sie eine Modell-ID oder einen lokalen Modellpfad ein.",
			reasonInvalidHubId:
		...
		dataset: {
			...
			streaming: {
				...
				blockers: {
					...
					trainOnCompletions: "Deaktivieren Sie „Nur Assistenten-Antworten“.",
					evalSplit:
		...
		params: {
			...
			contextLengthTooltip: "Maximale Anzahl an Token pro Trainingsbeispiel.",
			...
			rank: "Rank",
			rankTooltip: "Dimension der Low-Rank-Matrizen. Höher = mehr Kapazität.",
			alpha: "Alpha",
			alphaTooltip:
			...
			doraNeedsVisionLayersOff:
				"Training der Vision-Schichten deaktivieren, um DoRA zu nutzen",
		...
		training: {
			...
			configTooLarge: "Die Trainingskonfiguration ist zu groß (maximal 1 MiB).",
			...
			cancelDescription: "Möchten Sie den aktuellen Trainingslauf abbrechen?",
		...
		history: {
			...
			deleteArtifactsLabel:
				"Adapterdateien auf dem Datenträger ebenfalls löschen",
		...
		charts: {
			...
			waitingForFirstEvaluationStep: "Warte auf ersten Auswertungsschritt...",
		...
		trainingStart: {
			...
			waitingForFirstStep: "> {message} | warte auf ersten Schritt... ({step})",
	...
	modelMemory: {
		...
		oomLikely:
			"Mit den aktuellen Einstellungen ist ein Speicherüberlauf wahrscheinlich",
		tooLarge:
			"Größer als der VRAM, wird auf die CPU ausgelagert. Eine kleinere Quantisierung läuft schneller",
	},
	skills: {
		title: "Agentenfähigkeiten",
		description:
			"Fähigkeiten werden aus deinen Standard-Agentenordnern erkannt. Aktiviere sie hier und tippe dann @ im Chat, um eine zu erwähnen.",
		precedence: "~/.agents/skills hat Vorrang vor ~/.claude/skills.",
		refresh: "Aktualisieren",
		empty:
			"Keine Agentenfähigkeiten gefunden. Lege einen SKILL.md-Ordner unter ~/.agents/skills oder ~/.claude/skills an und aktualisiere dann.",
		sourceAgents: "Agents",
		sourceClaude: "Claude",
		...
		shadowedBy:
			"Eine andere Fähigkeit ({source}) mit diesem Namen hat Vorrang.",
