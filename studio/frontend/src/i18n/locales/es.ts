...
export const es = {
	...
	shell: {
		...
		selection: {
			...
			deleteDescription:
				"¿Eliminar {count} chats? Esta acción no se puede deshacer.",
	...
	settings: {
		groups: {
			...
			identityData: "Identidad y datos",
			runtimeAccess: "Ejecución y acceso",
			support: "Asistencia",
		},
		accounts: {
			title: "Cuentas",
			description:
				"Crea cuentas privadas de Studio. Los nuevos usuarios inician sesión con un código de configuración de un solo uso y eligen una contraseña.",
			username: "Nombre de usuario",
			create: "Crear cuenta",
			setupCode: "Código de configuración",
			setupFor: "Código de configuración para {username}",
			shownOnce:
				"Copia este código ahora y compártelo con el titular de la cuenta. Solo se muestra aquí y puede usarse una vez en un plazo de 60 minutos.",
			expires: "Caduca {expiry}",
			copy: "Copiar código de configuración",
			copied: "Copiado",
			copyFailed:
				"No se pudo copiar. Selecciona y copia el código de configuración de arriba.",
			dismiss: "Listo",
			...
			resetDescription:
				"Regenerar el código de configuración sustituye la contraseña de {username}, cierra sus sesiones y revoca sus claves de API. Dale el código nuevo para que elija otra contraseña.",
			deactivate: "Desactivar",
			reactivate: "Reactivar",
			delete: "Eliminar cuenta",
			deleteTitle: "¿Eliminar {username}?",
			deleteDescription:
				"Esto revoca las sesiones de {username} y cancela su trabajo. Sus chats, ajustes, credenciales, subidas, conjuntos de datos, entrenamientos, resultados, exportaciones, galerías, entornos aislados, proyectos y archivos temporales se retiran. Los directorios se renombran aparte, nunca se eliminan. Crear de nuevo este nombre de usuario inicia una cuenta nueva sin estos datos.",
			cancel: "Cancelar",
		...
		keyboardShortcuts: {
			...
			needsModifier:
				"Añade ⌘, Ctrl o Alt. Una tecla suelta se tragaría lo que escribes.",
			conflict: "También lo usa otro atajo",
			conflictShadowed:
				"Otro atajo tiene esta combinación y se ejecuta en lugar de este",
			edit: "Cambiar atajo",
			clear: "Quitar atajo",
			...
			actions: {
				...
				markChatUnread: {
					...
					description:
						"Marcar como no leídos los chats seleccionados o el chat actual",
				},
				togglePinChat: {
					label: "Alternar fijado",
					description:
						"Fijar o desfijar los chats seleccionados o el chat actual",
				},
				selectAllChats: {
				...
				clearChatSelection: {
					...
					description:
						"Anular la selección de los chats. Escape también la anula",
				},
				deleteSelectedChats: {
		...
		debugging: {
			...
			sourceHint:
				"Los ejecutores de modelos escriben sus propios registros, así que un fallo al cargar o al generar suele explicarse ahí y no en el registro del servidor.",
			path: "Ubicación",
			...
			privacyNote:
				"Las credenciales se enmascaran en esta vista. El archivo en disco no está enmascarado.",
			copyVisible: "Copiar el registro visible",
			empty: "Todavía no se ha registrado nada.",
			disabled:
				"El registro en archivo está desactivado (UNSLOTH_STUDIO_NO_FILE_LOG=1).",
			missing: "No se encontró ningún archivo de registro.",
			unreadable: "No se pudo leer el archivo de registro.",
			timeout:
				"La solicitud del registro agoto el tiempo de espera. Puede que el servidor no este accesible.",
			droppedNotice:
				"Se omitieron algunas líneas: el registro se escribió más rápido de lo que se podía leer.",
			morePending:
				"Aun se estan leyendo mas lineas; llegaran en la proxima actualizacion.",
			staleSession:
				"El registro en archivo esta desactivado, por lo que esta es una sesion anterior y no se actualizara.",
			downloadAllLogs: "Descargar todos los registros (.zip)",
			downloadingAllLogs: "Empaquetando los registros...",
			exportMaskedNote:
				"Las credenciales se enmascaran en los archivos exportados. Los registros muy grandes conservan solo sus líneas más recientes y algunos pueden quedar fuera por completo; consulta EXPORT_WARNINGS.txt en el archivo.",
			...
			exportTooOld:
				"El backend de Unsloth en ejecución es demasiado antiguo para exportar los registros. Actualízalo y reinícialo.",
			exportForbidden:
				"Para descargar todos los registros hace falta una sesión de Studio iniciada. Una clave de API no basta.",
			keywords:
				"depuracion depurar registro registros log logs error errores fallo traza diagnostico solucion de problemas debug",
		},
		voice: {
			title: "Voz",
		...
		general: {
			...
			password: "Contraseña",
			passwordDescription: "Cambia la contraseña de esta cuenta de Unsloth.",
			passwordDialog: {
			...
			modelAutoSwitch: {
				...
				idleNeedsEnable:
					"Activa primero «Cambiar de modelo según la solicitud».",
				idleActiveViaEnv:
				...
				idleError:
					"Introduce 0 para mantener el modelo cargado, o al menos 60 segundos.",
				...
				keepKv:
					"Conservar el contexto del chat al liberar el modelo por inactividad",
				keepKvDescription:
			...
			uploads: {
				...
				maxUploadSize:
					"Límite de subida del conjunto de datos de entrenamiento",
				maxUploadSizeDescription:
					"El valor predeterminado es {defaultSize} MB.",
			},
			rag: {
		...
		profile: {
			...
			stats: {
				...
				trainingDescription:
					"Ejecuciones de fine-tuning de este espacio de trabajo",
		...
		appearance: {
			...
			palette: {
				...
				classic: "Clásica",
				minimal: "Minimalista",
				glass: "Cristal neutro",
				materialPresets: "Preajustes de material",
				opaque: "Opaco",
				balanced: "Equilibrado",
				airy: "Etéreo",
				advancedMaterials: "Controles de material avanzados",
				sidebarSurface: "Barra lateral",
				chatSurface: "Superficie de chat",
				composerSurface: "Compositor",
				rightRailSurface: "Panel derecho",
				mainTransparency: "Transparencia del fondo principal",
				opacity: "Opacidad del cristal",
				opacityDescription:
					"Qué tan sólidas son las superficies esmeriladas. Un valor menor deja ver más.",
				blur: "Desenfoque del cristal",
				blurDescription:
					"Intensidad del efecto esmerilado en la barra lateral, las tarjetas y el compositor.",
			},
			custom: {
				reset: "Restablecer",
				...
				importFont: {
					...
					errorTooLarge:
						"El archivo de fuente es demasiado grande (máx. 1,5 MB).",
				...
				reduceMotion: {
					...
					description:
						"Reduce las animaciones o sigue la configuración del sistema.",
					system: "Sistema",
					on: "Activado",
					off: "Desactivado",
				},
		...
		resources: {
			...
			llamaBackend: {
				...
				applying: "Instalando...",
				applyHint:
					"Descarga la nueva compilación y reinicia llama.cpp. Se descargará el modelo que esté cargado.",
				applyHintWithSize:
					"Descarga {size} y reinicia llama.cpp. Se descargará el modelo que esté cargado.",
				...
				envLocked:
					"Fijado en {backend} por la variable de entorno UNSLOTH_LLAMA_CPP_BACKEND, que tiene prioridad sobre este ajuste.",
				customPath: {
					...
					active:
						"Tu llama-server personalizado se usará la próxima vez que cargues un modelo.",
					environmentManaged:
						"Gestionado por la variable de entorno {variable}.",
					missingBinary:
						"llama-server ya no está disponible en esta carpeta. Elige otra carpeta o usa el runtime incluido.",
					reloadRequired:
						"Vuelve a cargar el modelo para usar el llama-server seleccionado.",
					change: "Cambiar",
					saving: "Guardando...",
				...
				unsupported: {
					notInstalled:
						"No se encontró una instalación de llama.cpp gestionada, así que no hay backend que cambiar.",
					localLink:
						"llama.cpp es un directorio local que enlazaste tú, así que Unsloth no lo reemplazará.",
					sourceBuild:
						"Este llama.cpp se compiló desde el código fuente, así que su backend no se puede cambiar desde aquí.",
					customPath:
						"Hay una carpeta personalizada de llama.cpp seleccionada. Su compilación determina el backend de cómputo.",
					unresolved:
						"No se pudieron consultar los backends disponibles. Revisa tu conexión e inténtalo de nuevo.",
				},
			...
			storage: {
				...
				modelsFolderHint:
					"Dónde se guardan los modelos descargados. Cámbialo para mantener los modelos fuera de tu unidad del sistema. Solo se aplica a las descargas nuevas: los modelos que ya tienes se quedan donde están.",
				openAction: "Abrir",
				copyAction: "Copiar ruta",
				copied: "Ruta copiada",
				openError: "No se pudo abrir la carpeta",
		...
		agents: {
			...
			subagent: {
				...
				opencodePrompt:
					"@unsloth encuentra la causa de este fallo en las pruebas",
			},
			quickstart: {
		...
		chat: {
			...
			pastedTextThresholdDescription:
				"El texto pegado más largo que esto se convierte en un adjunto .txt en lugar de llenar el cuadro de mensaje. Pulsa {shortcut} para pegar en el cuadro de mensaje de todos modos.",
			...
			artifacts: {
				...
				blockedBannerPlural:
					"Se bloquearon {count} recursos externos de {hosts}.",
			...
			importedChatCountPartial:
				"Se importaron {count} conversaciones a Recientes; {failed} no se pudieron guardar.",
			importFailed: "La importación falló.",
			clearHistory: "Borrar historial de chat",
			clearHistoryDescription:
				"Elimina el historial de chat de este dispositivo.",
			clearAction: "Borrar",
		...
		data: {
			...
			archivedImagesDescription:
				"Consulta y gestiona las imágenes que has archivado.",
			archivedVideos: "Vídeos archivados",
			archivedVideosDescription:
				"Consulta y gestiona los vídeos que has archivado.",
			archivedAudio: "Audio archivado",
			archivedAudioDescription:
				"Consulta y gestiona los clips de audio que has archivado.",
	...
	studio: {
		...
		wizard: {
			...
			methodTooltip:
				"Cómo se entrena el modelo. LoRA y QLoRA actualizan adaptadores pequeños en lugar de todos los pesos.",
			datasetTooltip:
				"Los datos de entrenamiento usados para ajustar el modelo.",
			hfTokenDescription:
		...
		params: {
			...
			doraNeedsVisionLayersOff:
				"Desactiva el entrenamiento de las capas de visión para usar DoRA",
		...
		training: {
			...
			validation: {
				...
				learningRatePositive:
					"Introduce una tasa de aprendizaje mayor que cero.",
		...
		charts: {
			...
			trainingLossDescription:
				"Controla las superposiciones y el suavizado EMA.",
			smoothing: "Suavizado",
		...
		trainingStart: {
			...
			gettingReady: "> Estamos dejando todo listo para tu ejecución...",
			waitingForFirstStep: "> {message} | esperando el primer paso... ({step})",
			resumingTraining: "Reanudando entrenamiento...",
			startingTraining: "iniciando entrenamiento...",
			dataset: "Conjunto de datos",
			datasetStreaming: "Conjunto de datos: streaming (sin descarga completa)",
	...
	modelMemory: {
		...
		tooLarge:
			"Más grande que la VRAM, se descargará a la CPU. Una cuantización más pequeña es más rápida",
	},
	skills: {
		title: "Habilidades de agentes",
		description:
			"Las habilidades se detectan en tus carpetas de agentes estándar. Actívalas aquí y luego escribe @ en el chat para mencionar una.",
		precedence: "~/.agents/skills tiene prioridad sobre ~/.claude/skills.",
		refresh: "Actualizar",
		empty:
			"No se encontraron habilidades de agentes. Añade una carpeta con SKILL.md en ~/.agents/skills o ~/.claude/skills y actualiza.",
		sourceAgents: "Agents",
		sourceClaude: "Claude",
