...
export const ar = {
	picker: {
		...
		offlineBody: "انتقل إلى «الجهاز» لاستخدام {noun} المحلية أو المخزّنة مؤقتًا.",
		...
		multipleMatches: "توجد عدة نتائج مطابقة ضمن {noun}. اختر نتيجة من القائمة.",
	...
	shell: {
		...
		selection: {
			...
			deleteProjectsFilesDescription: "يُحذف مجلد مساحة عمل كل مشروع من القرص.",
	...
	settings: {
		groups: {
			...
			identityData: "الهوية والبيانات",
			runtimeAccess: "وقت التشغيل والوصول",
			support: "الدعم",
		},
		accounts: {
			title: "الحسابات",
			description:
				"أنشئ حسابات Studio خاصة. يسجّل المستخدمون الجدد الدخول برمز إعداد يُستخدم مرة واحدة ثم يختارون كلمة مرور.",
			username: "اسم المستخدم",
			create: "إنشاء حساب",
			setupCode: "رمز الإعداد",
			setupFor: "رمز الإعداد لـ {username}",
			shownOnce:
				"انسخ هذا الرمز الآن وشاركه مع صاحب الحساب. يظهر هنا فقط ويمكن استخدامه مرة واحدة خلال 60 دقيقة.",
			...
			resetDescription:
				"إعادة إنشاء رمز الإعداد تستبدل كلمة مرور {username} وتُنهي جلساته وتُلغي مفاتيح API الخاصة به. أعطه الرمز الجديد ليختار كلمة مرور من جديد.",
			deactivate: "تعطيل",
			reactivate: "إعادة التفعيل",
			delete: "حذف الحساب",
			deleteTitle: "حذف {username}؟",
			deleteDescription:
				"سيؤدي هذا إلى إلغاء جلسات {username} وإيقاف أعماله الجارية. تُسحب محادثاته وإعداداته وبيانات اعتماده وملفاته المرفوعة ومجموعات بياناته وعمليات التدريب والمخرجات والتصديرات والمعارض وبيئات العزل والمشاريع والملفات المؤقتة. يُعاد تسمية المجلدات وتُنحّى جانبًا ولا تُحذف أبدًا. إنشاء اسم المستخدم هذا مرة أخرى يبدأ حسابًا جديدًا دون أيٍّ من هذه البيانات.",
			cancel: "إلغاء",
		...
		keyboardShortcuts: {
			...
			actions: {
				...
				markChatUnread: {
					...
					description:
						"وضع علامة غير مقروءة على المحادثات المحددة، أو المحادثة الحالية",
				},
				togglePinChat: {
					label: "تبديل التثبيت",
					description:
						"تثبيت المحادثات المحددة أو إلغاء تثبيتها، أو المحادثة الحالية",
				},
				selectAllChats: {
				...
				nextChatNeedingAttention: {
					...
					description:
						"الانتقال إلى المحادثة التالية قيد التوليد أو الانتظار أو غير المقروءة",
				},
				clearAllUnreads: {
		...
		debugging: {
			...
			source: "ملف السجل",
			sourceHint:
				"تكتب مشغّلات النماذج سجلاتها الخاصة، لذا غالبًا ما يكون سبب فشل التحميل أو التوليد موضّحًا فيها لا في سجل الخادم.",
			path: "الموقع",
			pathCopy: "نسخ المسار",
			...
			privacyNote:
				"تُخفى بيانات الاعتماد في هذا العرض. أما في الملف الموجود على القرص فلا تُخفى.",
			...
			droppedNotice:
				"تم تخطي بعض الأسطر: كُتب السجل بسرعة أكبر مما أمكن قراءته.",
			...
			exportMaskedNote:
				"تُخفى بيانات الاعتماد في الملفات المصدَّرة. تحتفظ السجلات الكبيرة بأحدث أسطرها فقط، وقد يُستبعد بعضها بالكامل؛ راجع ملف EXPORT_WARNINGS.txt داخل الأرشيف.",
			...
			exportTooOld:
				"خادم Unsloth العامل أقدم من أن يدعم تصدير السجلات. حدِّثه وأعد تشغيله.",
			exportForbidden:
				"يتطلب تنزيل كل السجلات جلسة Studio مسجّل الدخول إليها. لا يكفي مفتاح API.",
			keywords:
				"تصحيح الأخطاء سجل السجلات خطأ أخطاء تعطل تتبع تشخيص استكشاف الأخطاء debug log logs error",
		},
		voice: {
			title: "الصوت",
			...
			dictation: {
				...
				customModelDescription:
					"اسم النموذج المرسل إلى /v1/audio/transcriptions.",
			...
			readAloud: {
				...
				engineStudioDescription: "يستخدم النموذج الصوتي المُحمَّل (مثل Orpheus)",
				...
				modelDescription: "حمّل نموذجًا صوتيًا من محدّد النماذج (مثل Orpheus TTS)",
		...
		general: {
			...
			autoTitleNewChatsDescription: "إنشاء عنوان قصير من الرسالة الأولى.",
			helperLlm: {
			...
			modelAutoSwitch: {
				...
				idleSecondsAriaLabel: "عدد الثواني قبل التفريغ التلقائي عند الخمول",
			...
			downloads: {
				...
				autoHint: "يختار حسب الجهاز وينتقل إلى HTTPS إذا تعطل Xet أو فشل هنا.",
			...
			uploads: {
				...
				maxUploadSizeDescription:
					"القيمة الافتراضية هي {defaultSize} ميجابايت.",
			},
			rag: {
		...
		appearance: {
			...
			palette: {
				...
				minimal: "بسيطة",
				glass: "زجاج محايد",
				materialPresets: "إعدادات المواد المسبقة",
				opaque: "معتم",
				balanced: "متوازن",
				airy: "شفاف",
				advancedMaterials: "عناصر تحكم متقدمة للمواد",
				sidebarSurface: "الشريط الجانبي",
				chatSurface: "سطح المحادثة",
				composerSurface: "مربع الإنشاء",
				rightRailSurface: "اللوحة اليمنى",
				mainTransparency: "شفافية الخلفية الرئيسية",
				opacity: "عتامة الزجاج",
				opacityDescription:
					"مدى صلابة الأسطح الضبابية. القيمة الأقل تجعلها أكثر شفافية.",
				blur: "تمويه الزجاج",
				blurDescription:
					"قوة التأثير الضبابي على الشريط الجانبي والبطاقات ومربع الإنشاء.",
			},
			custom: {
				reset: "إعادة تعيين",
				...
				pointerCursors: {
					...
					description: "تغيير المؤشر إلى يد عند المرور فوق العناصر التفاعلية.",
				},
			},
			language: {
				title: "اللغة",
		...
		resources: {
			...
			llamaBackend: {
				...
				applyHint:
					"ينزّل الإصدار الجديد ويعيد تشغيل llama.cpp. سيتم تفريغ النموذج المحمّل.",
				applyHintWithSize:
					"ينزّل {size} ويعيد تشغيل llama.cpp. سيتم تفريغ النموذج المحمّل.",
				...
				envLocked:
					"تم ضبطها على {backend} عبر متغيّر البيئة UNSLOTH_LLAMA_CPP_BACKEND، وهو يتجاوز هذا الإعداد.",
				customPath: {
					...
					missingBinary:
						"لم يعد llama-server متاحًا في هذا المجلد. اختر مجلدًا آخر أو استخدم وقت التشغيل المضمّن.",
				...
				unsupported: {
					notInstalled:
						"لم يُعثر على تثبيت llama.cpp مُدار، لذا لا توجد خلفية لتبديلها.",
					localLink: "llama.cpp مجلد محلي ربطته بنفسك، ولن يستبدله Unsloth.",
					sourceBuild:
						"بُني هذا الإصدار من llama.cpp من الشيفرة المصدرية، لذا لا يمكن تبديل خلفيته من هنا.",
					customPath:
						"تم تحديد مجلد llama.cpp مخصّص. يحدد هذا الإصدار خلفية الحوسبة.",
					unresolved:
						"تعذّر التحقق من الخلفيات المتاحة. تحقّق من اتصالك وحاول مرة أخرى.",
				},
			...
			modelMemory: {
				...
				keepResidentHint:
					"لا تُعاد الأوزان إلى ذاكرة النظام ما دام النموذج محمَّلاً. يعطّل التفريغ التلقائي عند الخمول، وإذا كانت الأوزان موجودة فعلاً في ذاكرة المضيف (ذاكرة موحّدة أو تفريغ جزئي إلى المعالج الرسومي) فإنه يمرّر ‎--mlock‎ أيضاً حتى لا يُخرجها النظام من الذاكرة ويعيد رفعها عند رسالتك التالية.",
				noRamReserve: "عدم حجز ذاكرة النظام للنموذج",
				noRamReserveDescription: "يقلل ذاكرة النظام المحجوزة لأوزان النموذج.",
				noRamReserveHint:
					"يتخطى التحميل المعتمد على تعيين الذاكرة في إصدارات ويندوز المدعومة عندما يكون النموذج محمّلاً بالكامل على كرت الرسوميات، فلا تبقى صفحاته مقيمة. وإلا يُبقي التحميل المعتمد على تعيين الذاكرة. قد تستهلك مخازن المعالج المطلوبة ذاكرة النظام. ويحذف ‎--no-mmap‎ و‎--mlock‎.",
				mlockVetoed:
					"يبقى ‎--mlock‎ معطَّلاً: تثبيت النموذج سيحجز ذاكرة تكفي حجمه كاملاً. ولا يزال التفريغ التلقائي عند الخمول معطَّلاً.",
				memlockCapped:
					"يحدّ هذا النظام الذاكرة المقفلة عند {limit}. لن يُثبَّت نموذج أكبر بالكامل؛ ارفع الحد باستخدام ulimit -l.",
			...
			storage: {
				...
				modelsFolderHint:
					"مكان تخزين النماذج التي جرى تنزيلها. غيّره لإبقاء النماذج بعيدًا عن قرص النظام. ينطبق على التنزيلات الجديدة فقط، أما النماذج الموجودة لديك فتبقى في مكانها.",
				openAction: "فتح",
				copyAction: "نسخ المسار",
				copied: "تم نسخ المسار",
				openError: "تعذّر فتح المجلد",
		...
		agents: {
			...
			quickstart: {
				...
				noneDetected:
					"لم يُعثر في متغيّر PATH لديك على أي واجهة أوامر لوكيل مدعوم.",
				installed: "مثبّت",
			},
			supportedAgents: {
			...
			options: {
				...
				contextLength: "يحدد طول السياق المطلوب (اسم بديل: ‎--max-seq-length).",
				ggufVariant: "يختار نسخة تكميم GGUF.",
				loadIn4bit: "يفعّل أو يعطّل التحميل بـ 4 بت لنماذج Hugging Face.",
				tensorParallel: "يفعّل أو يعطّل التوازي التنسوري عبر عدة أجهزة GPU.",
				serve: "يفعّل أو يعطّل الخادم المحلي التلقائي.",
				launch: "يشغّل الوكيل، أو يكتفي بطباعة الأمر والبيئة.",
				persist:
					"يحتفظ بمساحة تخزين الوكيل التي يديرها Unsloth بين عمليات التشغيل.",
				asSubagent:
		...
		chat: {
			...
			pastedTextThresholdDescription:
				"النص الملصق الأطول من هذا الحد يصبح مرفق \u200e.txt بدلاً من ملء مربع الرسالة. اضغط {shortcut} للصق في مربع الرسالة على أي حال.",
			...
			compactionStyleRollingDefault:
				"حذف الأدوار الأقدم (مساحة إضافية نحو 25%)",
			...
			importedChatCountPartial:
				"تم استيراد {count} محادثة إلى الأخيرة؛ تعذّر حفظ {failed} منها.",
			...
			clearOneChatDescription: "حذف المحادثة الوحيدة على هذا الجهاز نهائيًا.",
		...
		apiKeys: {
			...
			codingAgentsSwap:
				"استبدل claude بـ codex أو openclaw أو opencode أو hermes.",
			codingAgentDetected: "مثبّت على هذا الجهاز",
			codingAgentsDetectedHint:
				"وكلاء البرمجة المكتشفون على هذا الجهاز: {agents}.",
		...
		about: {
			...
			shutDownStudioDescription: "يوقف خادم Unsloth وينهي جلستك.",
			shutDown: "إيقاف التشغيل",
			update: {
				title: "تحديث Unsloth",
				...
				pullThenUpdate: "اسحب أحدث التغييرات، ثم شغّل المثبّت المحلي:",
				...
				desktopManualInstall: "افتح صفحة الإصدار لتثبيت أحدث حزمة لنظام Linux.",
	...
	studio: {
		...
		wizard: {
			...
			methodTooltip:
				"طريقة تدريب النموذج. يحدّث LoRA وQLoRA محوّلات صغيرة بدلاً من جميع الأوزان.",
			datasetTooltip: "بيانات التدريب المستخدمة لضبط النموذج.",
			hfTokenDescription: "مطلوب للنماذج ومجموعات البيانات المقيّدة أو الخاصة.",
			...
			cachedDatasetGoneTitle: "لم تعد مجموعة البيانات المخزّنة مؤقتًا متاحة",
		...
		datasetPicker: {
			...
			someLocationsUnscanned: "تعذّر فحص بعض مواقع مجموعات البيانات.",
			noLocalDatasets:
			...
			tokenRejectedBody: "حدّث التوكن في الإعدادات ← عام، ثم أعد المحاولة.",
		...
		modelPicker: {
			...
			noLocalModelsHint: "الصق مسار مجلد أعلاه أو انتقل إلى Hugging Face.",
			searchingHub: "جارٍ البحث في Hugging Face…",
			...
			reasonAdapter: "لا يمكن استخدام مخرجات المهايئ كنماذج أساسية للتدريب.",
		...
		dataset: {
			...
			streaming: {
				...
				completionsUnavailable: "غير متاح أثناء تفعيل بث مجموعة البيانات.",
				blockers: {
					source:
					...
					appleSilicon: "البث غير مدعوم على Apple Silicon (MLX) حتى الآن.",
				},
				options: {
		...
		params: {
			...
			dropout: "Dropout",
			dropoutTooltip: "احتمال Dropout لطبقات LoRA لتقليل فرط التخصيص.",
		...
		training: {
			...
			validation: {
				...
				embeddingLearningRateRange: "أدخل معدل تعلم تضمين أكبر من 0 وأقل من 1.",
			...
			configTooLarge: "ملف تكوين التدريب كبير جدًا (الحد الأقصى 1 MiB).",
			failedToReadFile: "فشلت قراءة الملف",
			failedToSaveConfig: "فشل حفظ التكوين",
			parametersReset:
				"تمت إعادة تعيين المعلمات إلى إعدادات النموذج الافتراضية",
			audioIncompatible:
		...
		history: {
			...
			deleteArtifactsFailed: "تم حذف العملية، لكن تعذّرت إزالة ملفاتها.",
		...
		charts: {
			...
			settingsDescription: "اضبط عرض الرسم البياني بينما يستمر التدريب.",
	...
	modelMemory: {
		...
		tooLarge:
			"أكبر من ذاكرة الرسوميات، وسيُفرَّغ جزء منه إلى المعالج. التكميم الأصغر أسرع",
	},
	skills: {
		title: "مهارات الوكلاء",
		description:
			"تُكتشف المهارات من مجلدات الوكلاء القياسية. فعّلها هنا ثم اكتب @ في الدردشة لذكر إحداها.",
		precedence: "‎~/.agents/skills له الأولوية على ‎~/.claude/skills.",
		refresh: "تحديث",
		empty:
			"لم يُعثر على مهارات. أضف مجلدًا يحتوي على SKILL.md ضمن ‎~/.agents/skills أو ‎~/.claude/skills ثم حدّث.",
		sourceAgents: "Agents",
		sourceClaude: "Claude",
