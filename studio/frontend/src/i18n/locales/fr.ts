...
export const fr = {
	...
	shell: {
		...
		navigation: {
			...
			audio: "Audio",
			trainChecking:
				"Vérification de la prise en charge de l'entraînement sur cette machine...",
			videoChecking:
				"Vérification de la prise en charge de la vidéo sur cette machine...",
			more: "Plus",
		...
		selection: {
			...
			deleteDescription:
				"Supprimer {count} discussions ? Cette action est irréversible.",
		...
		dialog: {
			deleteChat: {
				...
				description:
					'Voulez-vous vraiment supprimer cette discussion "{name}" ?',
			},
			deleteRun: {
				title: "Supprimer l'entraînement",
				description:
					'Voulez-vous vraiment supprimer cet entraînement "{name}" ?',
			},
			renameChat: {
	...
	settings: {
		groups: {
			...
			identityData: "Identité et données",
			runtimeAccess: "Exécution et accès",
			support: "Assistance",
		},
		accounts: {
			title: "Comptes",
			description:
				"Créez des comptes Studio privés. Les nouveaux utilisateurs se connectent avec un code de configuration à usage unique et choisissent un mot de passe.",
			username: "Nom d'utilisateur",
			create: "Créer un compte",
			setupCode: "Code de configuration",
			setupFor: "Code de configuration pour {username}",
			shownOnce:
				"Copiez ce code maintenant et transmettez-le au titulaire du compte. Il n'est affiché qu'ici et ne peut être utilisé qu'une seule fois dans les 60 minutes.",
			expires: "Expire {expiry}",
			copy: "Copier le code de configuration",
			copied: "Copié",
			copyFailed:
				"Impossible de copier. Sélectionnez et copiez le code de configuration ci-dessus.",
			dismiss: "Terminé",
		...
		keyboardShortcuts: {
			...
			recordingHint:
				"Appuyez sur la nouvelle combinaison, ou Échap pour annuler.",
			needsModifier:
				"Ajoutez ⌘, Ctrl ou Alt. Une touche seule avalerait la saisie.",
			conflict: "Également utilisé par un autre raccourci",
			conflictShadowed:
				"Un autre raccourci utilise cette combinaison et s'exécute à sa place",
			...
			actions: {
				...
				newTemporaryChat: {
					...
					description:
						"Démarrer une discussion qui n’est pas enregistrée dans l’historique",
				},
				newStandaloneChat: {
				...
				archiveChat: {
					...
					description:
						"Archiver les discussions sélectionnées, sinon celle en cours",
				},
				markChatUnread: {
					label: "Marquer comme non lu",
					description:
						"Marquer comme non lues les discussions sélectionnées, sinon celle en cours",
				},
				togglePinChat: {
					label: "Épingler/désépingler",
					description:
						"Épingler ou désépingler les discussions sélectionnées, sinon celle en cours",
				},
				selectAllChats: {
				...
				clearChatSelection: {
					...
					description:
						"Désélectionner les chats sélectionnés. Échap le fait aussi",
				},
				deleteSelectedChats: {
				...
				nextChatNeedingAttention: {
					...
					description:
						"Passer à la discussion suivante en cours, en file ou non lue",
				},
				clearAllUnreads: {
				...
				copyChatAsMarkdown: {
					...
					description:
						"Copier toute la discussion dans le presse-papiers en Markdown",
				},
				copySessionId: {
		...
		debugging: {
			...
			sourceHint:
				"Les exécuteurs de modèles écrivent leurs propres journaux : un chargement ou une génération en échec y est donc souvent expliqué plutôt que dans le journal du serveur.",
			path: "Emplacement",
			...
			privacyNote:
				"Les identifiants sont masqués dans cette vue. Dans le fichier sur le disque, ils ne le sont pas.",
			copyVisible: "Copier le journal visible",
			empty: "Rien n'a encore été consigné.",
			disabled:
				"La journalisation dans un fichier est désactivée (UNSLOTH_STUDIO_NO_FILE_LOG=1).",
			missing: "Aucun fichier journal n'a été trouvé.",
			unreadable: "Le fichier journal n'a pas pu être lu.",
			timeout:
				"La demande du journal a expire. Le serveur est peut-etre injoignable.",
			droppedNotice:
				"Certaines lignes ont été ignorées : le journal a été écrit plus vite qu'il ne pouvait être lu.",
			morePending:
				"D'autres lignes sont encore en cours de lecture ; elles arriveront au prochain rafraichissement.",
			staleSession:
				"La journalisation dans un fichier est desactivee : il s'agit d'une session anterieure, qui ne sera pas mise a jour.",
			downloadAllLogs: "Télécharger tous les journaux (.zip)",
			downloadingAllLogs: "Préparation de l'archive...",
			exportMaskedNote:
				"Les identifiants sont masqués dans les fichiers exportés. Les journaux très volumineux ne conservent que leurs lignes les plus récentes, et certains peuvent être omis entièrement ; voir EXPORT_WARNINGS.txt dans l'archive.",
			...
			exportTooOld:
				"Le backend Unsloth en cours d'exécution est trop ancien pour exporter les journaux. Mettez-le à jour et redémarrez-le.",
			exportForbidden:
				"Le téléchargement de tous les journaux nécessite une session Studio connectée. Une clé d'API ne suffit pas.",
			keywords:
				"debogage deboguer journal journaux log logs erreur erreurs plantage trace diagnostic depannage debug",
		},
		voice: {
			title: "Voix",
			description:
				"Microphone, dictée, reconnaissance vocale et lecture à voix haute",
			dictation: {
				sectionTitle: "Dictée",
		...
		general: {
			...
			passwordDescription: "Changez le mot de passe de ce compte Unsloth.",
			passwordDialog: {
			...
			modelAutoSwitch: {
				...
				idleNeedsEnable: "Activez d’abord « Changer de modèle par requête ».",
				...
				idleError:
					"Saisissez 0 pour garder le modèle chargé, ou au moins 60 secondes.",
			...
			uploads: {
				...
				maxUploadSize:
					"Limite de téléversement du jeu de données d'entraînement",
		...
		appearance: {
			...
			palette: {
				label: "Palette",
				description:
					"Couleurs utilisées dans Unsloth, en mode clair et sombre.",
				standard: "Standard",
				classic: "Classique",
				minimal: "Minimale",
				glass: "Verre neutre",
				materialPresets: "Préréglages de matière",
				opaque: "Opaque",
				balanced: "Équilibré",
				airy: "Aérien",
				advancedMaterials: "Réglages avancés des matières",
				sidebarSurface: "Barre latérale",
				chatSurface: "Surface de discussion",
				composerSurface: "Zone de saisie",
				rightRailSurface: "Panneau droit",
				mainTransparency: "Transparence de l’arrière-plan principal",
				opacity: "Opacité du verre",
				opacityDescription:
					"Opacité des surfaces givrées. Une valeur plus faible les rend plus transparentes.",
				blur: "Flou du verre",
				blurDescription:
					"Intensité du givrage de la barre latérale, des cartes et de la zone de saisie.",
			},
			custom: {
				reset: "Réinitialiser",
				...
				importFont: {
					...
					errorTooLarge:
						"Le fichier de police est trop volumineux (1,5 Mo max.).",
				...
				uiFontSize: {
					...
					description:
						"Ajustez la taille de base utilisée pour l'interface Unsloth.",
				},
				codeFontSize: {
		...
		resources: {
			...
			llamaBackend: {
				...
				description:
					"Le backend utilisé par llama.cpp pour exécuter les modèles GGUF.",
				...
				applyHint:
					"Télécharge la nouvelle version et redémarre llama.cpp. Un modèle chargé sera déchargé.",
				applyHintWithSize:
					"Télécharge {size} et redémarre llama.cpp. Un modèle chargé sera déchargé.",
				switchedTo: "llama.cpp fonctionne maintenant sur {backend}.",
				switchFailed: "Impossible de changer le backend llama.cpp.",
				switchInterrupted:
					"Le changement a été interrompu avant d’être terminé.",
				envLocked:
					"Fixé à {backend} par la variable d'environnement UNSLOTH_LLAMA_CPP_BACKEND, qui prévaut sur ce réglage.",
				customPath: {
					...
					active:
						"Votre llama-server personnalisé sera utilisé au prochain chargement de modèle.",
					environmentManaged:
						"Géré par la variable d'environnement {variable}.",
					missingBinary:
						"llama-server n'est plus disponible dans ce dossier. Choisissez un autre dossier ou utilisez le runtime fourni.",
					reloadRequired:
						"Rechargez le modèle pour utiliser le llama-server sélectionné.",
					change: "Modifier",
					saving: "Enregistrement...",
				...
				unsupported: {
					notInstalled:
						"Aucune installation llama.cpp gérée n'a été trouvée, il n'y a donc pas de backend à changer.",
					localLink:
						"llama.cpp est un dossier local que vous avez lié vous-même ; Unsloth ne le remplacera pas.",
					sourceBuild:
						"Ce llama.cpp a été compilé depuis les sources, son backend ne peut pas être changé ici.",
					customPath:
						"Un dossier llama.cpp personnalisé est sélectionné. Son build détermine le backend de calcul.",
					unresolved:
						"Impossible de vérifier les backends disponibles. Vérifiez votre connexion et réessayez.",
				},
			...
			modelMemory: {
				...
				keepResidentHint:
					"Ne rend pas les poids à la RAM système tant que le modèle reste chargé. Désactive le déchargement automatique en veille et, lorsque les poids résident réellement en RAM hôte (mémoire unifiée ou déchargement GPU partiel), passe aussi --mlock afin que le système ne les décharge pas pour les retransférer au prochain message.",
				noRamReserve: "Ne pas réserver de RAM système pour le modèle",
				noRamReserveDescription:
					"Réduit la RAM occupée par les poids du modèle.",
				noRamReserveHint:
					"Ignore le chargement mappé en mémoire sur les versions Windows compatibles lorsque le modèle est entièrement déchargé sur le GPU, afin que ses pages ne restent pas résidentes. Sinon, conserve le chargement mappé en mémoire. Les tampons CPU nécessaires peuvent toujours occuper de la RAM. Supprime --no-mmap et --mlock.",
				mlockVetoed:
					"--mlock reste désactivé : épingler le modèle réserverait de la RAM pour l'intégralité de celui-ci. Le déchargement automatique en veille reste désactivé.",
				memlockCapped:
					"Ce système limite la mémoire verrouillée à {limit}. Un modèle plus grand ne sera pas entièrement épinglé ; augmentez la limite avec ulimit -l.",
				reloadRequired:
					"Rechargez le modèle pour appliquer les nouvelles options de mémoire.",
				loadError: "Impossible de charger les paramètres de mémoire du modèle",
				saveError:
					"Impossible d'enregistrer les paramètres de mémoire du modèle",
			...
			storage: {
				...
				modelsFolderHint:
					"Où sont stockés les modèles téléchargés. Modifiez-le pour garder les modèles hors de votre disque système. S'applique uniquement aux nouveaux téléchargements. Les modèles que vous avez déjà restent où ils sont.",
				openAction: "Ouvrir",
				copyAction: "Copier le chemin",
				copied: "Chemin copié",
				openError: "Impossible d'ouvrir le dossier",
		...
		agents: {
			...
			options: {
				...
				yolo: "Ignore les demandes d'autorisation. À n'utiliser que dans des environnements de confiance.",
			},
			remote: {
		...
		chat: {
			...
			pastedTextThresholdDescription:
				"Le texte collé plus long que cette valeur devient une pièce jointe .txt au lieu de remplir le champ de message. Appuyez sur {shortcut} pour coller quand même dans le champ de message.",
			...
			currentDate: {
				...
				saveError:
					"Impossible de mettre à jour les paramètres de date actuelle",
			},
			tools: {
			...
			artifacts: {
				...
				blockedBannerPlural:
					"{count} ressources externes bloquées depuis {hosts}.",
			...
			importingChats:
				"Import des discussions : {count} jusqu'ici ({percent}%)...",
			importedChatCountPartial:
				"{count} conversations importées dans Récents ; {failed} n'ont pas pu être enregistrées.",
		...
		data: {
			...
			archivedImagesDescription:
				"Consultez et gérez les images que vous avez archivées.",
			archivedVideos: "Vidéos archivées",
			archivedVideosDescription:
				"Consultez et gérez les vidéos que vous avez archivées.",
			archivedAudio: "Audio archivé",
			archivedAudioDescription:
				"Consultez et gérez les clips audio que vous avez archivés.",
			manageAction: "Gérer",
			...
			exportedArchivedChatCount:
				"{count} discussions archivées ont été exportées",
	...
	studio: {
		...
		wizard: {
			...
			methodTooltip:
				"Comment le modèle est entraîné. LoRA et QLoRA mettent à jour de petits adaptateurs au lieu de tous les poids.",
			datasetTooltip:
				"Les données d'entraînement utilisées pour affiner le modèle.",
			hfTokenDescription:
		...
		dataset: {
			selectors: {
				...
				manualInvalid:
					"Cette valeur contient des caractères non pris en charge.",
			},
			...
			streamingInfoAriaLabel: "Informations sur le streaming du jeu de données",
			streaming: {
				...
				options: {
					...
					evaluation: "évaluation (nécessite un split d'évaluation distinct)",
				},
				notifications: {
					turnedOffMaxSteps:
		...
		params: {
			...
			doraNeedsVisionLayersOff:
				"Désactivez l'entraînement des couches de vision pour utiliser DoRA",
		...
		training: {
			...
			validation: {
				...
				learningRatePositive:
					"Saisissez un taux d'apprentissage supérieur à zéro.",
			...
			parametersReset:
				"Paramètres réinitialisés aux valeurs par défaut du modèle",
			audioIncompatible:
		...
		charts: {
			...
			trainingLossDescription:
				"Contrôlez les superpositions et le lissage EMA.",
			smoothing: "Lissage",
		...
		trainingStart: {
			...
			dataset: "Jeu de données",
			datasetStreaming:
				"Jeu de données : streaming (pas de téléchargement complet)",
	...
	modelMemory: {
		...
		oomLikely:
			"Avec les réglages actuels, un dépassement de mémoire est probable",
		tooLarge:
			"Plus volumineux que la VRAM, sera déchargé sur le CPU. Une quantification plus petite est plus rapide",
	},
	skills: {
		title: "Compétences des agents",
		description:
			"Les compétences sont détectées dans vos dossiers d'agents standard. Activez-les ici, puis tapez @ dans le chat pour en mentionner une.",
		precedence:
			"~/.agents/skills est prioritaire par rapport à ~/.claude/skills.",
		refresh: "Actualiser",
		empty:
			"Aucune compétence d'agent trouvée. Ajoutez un dossier SKILL.md dans ~/.agents/skills ou ~/.claude/skills, puis actualisez.",
		sourceAgents: "Agents",
		sourceClaude: "Claude",
		...
		shadowedBy:
			"Une autre compétence ({source}) portant ce nom est prioritaire.",
		enable: "Activer {name}",
