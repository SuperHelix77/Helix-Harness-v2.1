...
export const CompactionNotice: FC<{ truncation: ContextTruncation }> = ({
  ...
  const detail = archived
    ? "They were handed to memory. Call search_memory or use the Workspace Memory tab to continue without losing the thread."
    ...
    >
      ...
      <div className="min-w-0">
        <span className="font-medium text-foreground/80">
          This conversation got long, so it was handed to memory.
        </span>{" "}
        <span>
