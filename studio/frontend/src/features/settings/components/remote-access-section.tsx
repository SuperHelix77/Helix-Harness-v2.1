    ...
    <SettingsRow
      ...
      description={
        multi
          ...
          : "Remote browsers use the compatibility account named unsloth. Helix Harness keeps its desktop session automatic."
      }
    >
    ...
    >
        ...
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="flex min-w-0 flex-col gap-0.5">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Use Helix Harness and its APIs from other devices through a secure,
      ...
      <div className="border-t border-border/60 px-4 py-1">
        ...
        <SettingsRow
          ...
          description="Create a new remote URL each time Helix Harness starts. Stopping remote access now won’t turn this off."
        >
          <Switch
