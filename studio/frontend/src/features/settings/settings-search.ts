...
export const SETTINGS_SEARCH_INDEX: Record<SettingsTab, TranslationKey[]> = {
  ...
  appearance: [
    ...
    "settings.appearance.palette.glass",
    "settings.appearance.palette.mainTransparency",
		"settings.appearance.palette.sidebarSurface",
		"settings.appearance.palette.chatSurface",
		"settings.appearance.palette.composerSurface",
		"settings.appearance.palette.rightRailSurface",
    "settings.appearance.palette.opacity",
    "settings.appearance.palette.blur",
