...
import {
  ...
  hasRefreshToken,
  mustChangePassword,
  persistDesktopRefreshCredential,
    ...
    try {
      ...
      if (isLoginMode) {
        ...
        if (!accessToken) {
          ...
          await persistDesktopRefreshCredential(bootstrapToken.refresh_token);
      ...
      await persistDesktopRefreshCredential(token.refresh_token);
  ...
  return (
    <div className="w-full max-w-sm space-y-6">
      <div className="space-y-1.5 text-center">
        <MascotImg
          src="helix-mark.svg"
          className="helix-logo mx-auto mb-2 h-20 w-20 object-contain"
        />
