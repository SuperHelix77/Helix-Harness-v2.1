...
const DESKTOP_RELEASE_PAGE_BASE_URL: &str =
    "https://github.com/SuperHelix77/Helix-Harness-v2.1/releases/tag/";
const DESKTOP_RELEASE_TAG_PREFIX: &str = "v";
const DESKTOP_UPDATER_MANIFEST_URL: &str =
    "https://github.com/SuperHelix77/Helix-Harness-v2.1/releases/latest/download/latest.json";
...
pub(crate) fn desktop_update_policy(app: tauri::AppHandle) -> DesktopUpdatePolicy {
    DesktopUpdatePolicy {
        mode: desktop_update_mode(updater_endpoints_configured(&app)),
...
#[tauri::command]
pub(crate) async fn check_desktop_manual_update(
    app: tauri::AppHandle,
) -> Result<Option<ManualUpdateInfo>, String> {
    if !matches!(
        desktop_update_mode(updater_endpoints_configured(&app)),
...
fn validate_channel_metadata(
    ...
    let expected_prefix = format!(
        "https://github.com/SuperHelix77/Helix-Harness-v2.1/releases/download/v{normalized_version}/"
    );
...
fn updater_endpoints_configured(app: &tauri::AppHandle) -> bool {
    app.config()
        .plugins
        .0
        .get("updater")
...
fn desktop_update_mode(updater_configured: bool) -> DesktopUpdateMode {
...
mod tests {
    ...
    fn updater_policy_uses_normal_release_discovery_and_links() {
        ...
        let metadata = metadata_with_url(
            "https://github.com/SuperHelix77/Helix-Harness-v2.1/releases/download/v0.1.528-beta/app.AppImage",
        );
        assert!(super::validate_channel_metadata(&metadata, "0.1.528-beta").is_ok());
    }

    #[test]
    fn empty_updater_channel_is_explicitly_disabled() {
        assert_eq!(
            super::desktop_update_mode(false),
            super::DesktopUpdateMode::Disabled
        );
    }
    ...
    fn updater_policy_rejects_moving_legacy_mismatched_and_foreign_asset_urls() {
        for url in [
            "https://github.com/SuperHelix77/Helix-Harness/releases/latest/download/app.AppImage",
            "https://github.com/SuperHelix77/Helix-Harness/releases/download/desktop-latest/app.AppImage",
            "https://github.com/SuperHelix77/Helix-Harness/releases/download/desktop-v0.1.528-beta/app.AppImage",
            "https://github.com/SuperHelix77/Helix-Harness/releases/download/v0.1.529-beta/app.AppImage",
            "https://github.com/example/Helix-Harness/releases/download/v0.1.528-beta/app.AppImage",
        ] {
