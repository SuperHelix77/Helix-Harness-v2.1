...
async def stream_with_studio_tools(
    ...
    *,
    ...
    while not cancel_event.is_set():
        ...
        for _call_index, call in enumerate(calls):
            ...
            from core.inference.durable_tool_journal import freeze_pre_tool_checkpoint
            ...
            _checkpoint, _checkpoint_digest = freeze_pre_tool_checkpoint(
                {
                    ...
                    "remaining_calls": list(calls)[_call_index + 1 :],
            ...
            try:
                ...
                if approval_id and verdict is not None:
            ...
            completion = settle_controller_completion(result, decision, controller)
